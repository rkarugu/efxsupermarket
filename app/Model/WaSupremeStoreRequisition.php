...
class WaSupremeStoreRequisition extends Model
{
    protected $table = "wa_supreme_store_requisitions";
    use Sluggable;
    public function sluggable(): array {
     ...
     public function getRelatedItem() {
         return $this->hasMany('App\Model\WaSupremeStoreRequisitionItem', 'wa_supreme_store_requisitions_id');
    }
    ...
    public function getBranch() {
     ...
     public function getrelatedEmployee() {
      ...
      public function getRelatedAuthorizationPermissions() {
         return $this->hasMany('App\Model\WaSupremeStoreReqPermission', 'wa_supreme_store_requisition_id')->orderBy('approve_level','asc');
    }
