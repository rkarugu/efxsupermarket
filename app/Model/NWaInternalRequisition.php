...
class NWaInternalRequisition extends Model
{
    ...
    public function sluggable(): array {
     ...
     public function getRelatedItem() {
         return $this->hasMany('App\Model\NWaInternalRequisitionItem', 'wa_internal_requisition_id');
    }
    ...
    public function getShiftInfo() {
     ...
     public function getrelatedEmployee() {
      ...
      public function getRelatedAuthorizationPermissions() {
         return $this->hasMany('App\Model\NWaInternalReqPermission', 'wa_internal_requisition_id')->orderBy('approve_level','asc');
    }
