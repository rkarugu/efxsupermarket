...
class NWaInventoryLocationTransferDemo extends Model
{
    ...
    public function sluggable(): array {
      ...
      public function getRelatedItem() {
         return $this->hasMany('App\Model\NWaInventoryLocationTransferItemDemo', 'wa_inventory_location_transfer_id');
    }
