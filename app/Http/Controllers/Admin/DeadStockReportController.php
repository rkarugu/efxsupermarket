...
class DeadStockReportController extends Controller
{
    ...
    {
        $this->model = 'dead-stock-report';
        $this->title = 'Dead Stock Report';
        $this->pmodel = 'dead-stock-report';
    }

    public function index()
    {
        if (!can('dead-stock-report', 'inventory-reports')) {
        ...
        if (request()->action) {
            ...
            if (request()->action == 'excel') {
                $view = view('admin.reports.export.dead_stock_report', [
                ...
                return Excel::download(new ExportViewToExcel($view), 'dead_stock_report_' . date('YmdHis') . '.xlsx');
            }
        }
        ...
        return view('admin.reports.deadstock', [
            'model' => $this->model,
            'title' => $this->title,
