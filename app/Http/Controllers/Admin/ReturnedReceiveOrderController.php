...
class ReturnedReceiveOrderController extends Controller
{

    protected $model;
    protected $title;
    protected $pmodule;
    private $path = "admin.receivepurchaseorders.returns.";
    private $consts = [
        'Accepted'=>'Accepted',
        'Rejected'=>'Rejected',
        'Pending'=>'Pending'
    ...
    {
        $this->model = 'returned-receive-purchase-order';
        $this->title = 'Returned Receive Purchase Order';
        $this->pmodule = 'pending-returns-receive-purchase-order';
    }
