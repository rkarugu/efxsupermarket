    ...
    <div class="box box-primary">
            <div :class="{ 'box-header-sticky': isSticky }" class="box-header with-border">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="box-title">Operations Dashboard - Sales Summary</h4>
                    <div>
                    <!-- Tabs go here -->
                    <ul class="nav nav-tabs">
                        ...
                        <!-- <li class="nav-item">
                            <a 
                                class="nav-link" 
                                :class="{ active: activeTab === 'fuel-consumed-yesterday' }" 
                                href="#fuel-consumed-yesterday" 
                                @click.prevent="setActiveTab('fuel-consumed-yesterday')"
                            >Fuel</a>
                        </li> -->
                        <li class="nav-item">
                            <a 
            ...
            <div class="box-body">
                ...
                <div class="row"  id="sales-summary">
                 ...
                 <!-- Unvisited Shifts Summary -->
                <div class="row"  id="sales-summary">
                        <div class="col-md-12">
                            <Card cardTitle="Shifts Without Orders">
                                <UnvisitedShiftsSummary :branchId="branchId" :startDate="startDate" />
                            </Card>
                        </div>
                </div>  

                <!-- Fuel Consumed Yesterday -->
                <!-- <div class="row">
                    <div class="col-md-12" id="fuel-consumed-yesterday">
                        <Card cardTitle="Fuel Consumed Yesterday">
                            <FuelConsumedYesterday :branchId="branchId" :startDate="startDate" />
                        </Card>
                    </div>
                 </div>
                 <div class="row">
                    <div class="col-md-12" id="unfuelled-vehicles">
                        <Card cardTitle="Unfuelled Vehicles">
                            <UnfuelledVehicles :branchId="branchId" :startDate="startDate" />
                        </Card>
                    </div>
                 </div> -->
                 <!-- Other Deliveries -->
...
import UnvisitedShiftsSummary from '@/components/chairman-general-dashboard/UnvisitedShiftsSummary.vue'
