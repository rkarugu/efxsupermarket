<template>
    <Card cardTitle="PAYE Deductions Report">
...
const generateReport = () => {
    ...
    apiClient.post('hr/payroll/reports/paye-deductions-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'paye_deductions_report.xlsx');
            ...
            formUtil.successMessage("PAYE deductions report has been generated successfully.")
