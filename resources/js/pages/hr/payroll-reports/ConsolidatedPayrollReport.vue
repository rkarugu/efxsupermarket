<template>
    <Card cardTitle="Consolidated Payroll Report">
...
const generateReport = () => {
    ...
    apiClient.post('hr/payroll/reports/consolidated-payroll-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'consolidated_payroll_report.xlsx');
            ...
            formUtil.successMessage("Consolidated payroll report has been generated successfully.")
