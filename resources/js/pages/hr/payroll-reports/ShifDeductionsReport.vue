<template>
    <Card cardTitle="SHIF Deductions Report">
...
const generateReport = () => {
    ...
    apiClient.post('hr/payroll/reports/shif-deductions-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'shif_deductions_report.xlsx');
            ...
            formUtil.successMessage("SHIF deductions report has been generated successfully.")
