<template>
    <Card cardTitle="Other Deductions Report">
...
const generateReport = () => {
    ...
    if (!deductionId.value) {
        formUtil.errorMessage("Please select a deduction.")
        return
    }
    
    processing.value = true
    
    apiClient.post('hr/payroll/reports/other-deductions-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'other_deductions_report.xlsx');
            ...
            formUtil.successMessage("Other deductions report has been generated successfully.")
