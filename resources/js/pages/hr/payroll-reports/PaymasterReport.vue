<template>
    <Card cardTitle="Paymaster Report">
...
const generateReport = () => {
    ...
    apiClient.post('hr/payroll/reports/paymaster-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'paymaster_report.xlsx');
            ...
            formUtil.successMessage("Paymaster report has been generated successfully.")
