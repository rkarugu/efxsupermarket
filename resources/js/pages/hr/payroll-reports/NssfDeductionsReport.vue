<template>
    <Card cardTitle="NSSF Deductions Report">
...
const generateReport = () => {
    ...
    apiClient.post('hr/payroll/reports/nssf-deductions-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'nssf_deductions_report.xlsx');
            ...
            formUtil.successMessage("NSSF deductions report has been generated successfully.")
