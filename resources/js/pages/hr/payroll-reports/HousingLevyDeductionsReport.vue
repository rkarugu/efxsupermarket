<template>
    <Card cardTitle="Housing Levy Deductions Report">
...
const generateReport = () => {
    ...
    apiClient.post('hr/payroll/reports/housing-levy-deductions-report', {
        ...
        .then(response => {
            ...
            link.setAttribute('download', 'housing_levy_deductions_report.xlsx');
            ...
            formUtil.successMessage("Housing levy deductions report has been generated successfully.")
