<template>
    <Card cardTitle="Edit Casual">
        ...
        <div class="pull-right">
            ...
            <button class="btn btn-primary" style="margin-left: 10px;" @click="handleSubmit">
...
const casual = ref(JSON.parse(props.casual))
...
const initForm = () => {
    form.value = {
        first_name: casual.value.first_name,
        middle_name: casual.value.middle_name,
        last_name: casual.value.last_name,
        date_of_birth: casual.value.date_of_birth,
        id_no: casual.value.id_no,
        phone_no: casual.value.phone_no,
        email: casual.value.email,
        gender_id: casual.value.gender_id,
        nationality_id: casual.value.nationality_id,
        branch_id: casual.value.branch_id,
    }
}
...
const handleSubmit = () => {
    ...
    apiClient.post(`hr/management/casuals/${casual.value.id}`, form.value)
        .then(response => {
            formUtil.successMessage(response.data.message)

            casual.value = response.data.data
