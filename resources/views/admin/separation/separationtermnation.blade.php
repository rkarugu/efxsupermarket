...
.onoffswitch3-checkbox:checked + .onoffswitch3-label .onoffswitch3-switch {
    ...
    action="{{route('separation.create')}}" enctype = "multipart/form-data">
      {{ csrf_field() }}
    <div class="col-lg-6">
                <div class="form-group">
                <label for="inputEmail3" class="col-lg-3 control-label"   style="margin-top: 5px;">Type of Termination</label>
                    <div class="col-lg-9" style="margin-top: 5px;">
                    {!!Form::select('type_of_termination', $termination_types, null, ['placeholder'=>'Select Type of Termination', 'class' => 'form-control','required'=>true,'title'=>'Please Type of Termination'  ])!!} 
                    </div>
                </div>
                 <div class="form-group">
            <input type="hidden" name="emp_id" value="{{$dataEmp3->id}}">
                    ...
                    <div class="col-lg-9" style="margin-top: 5px;">
                    {!! Form::text('termination_date',null, ['maxlength'=>'255','placeholder' => 'Termination Date', 'required'=>true, 'class'=>'form-control datepicker','readonly'=>true]) !!}  
                    </div>
                </div>
                 <div class="form-group">
                    <label for="inputEmail3" class="col-lg-3 control-label"   style="margin-top: 5px;">Last Day Worked</label>
                    <div class="col-lg-9" style="margin-top: 5px;">
                         {!! Form::text('last_day_worked',null, ['maxlength'=>'255','placeholder' => 'Last Day Worked', 'required'=>true, 'class'=>'form-control datepicker','readonly'=>true]) !!} 
                    </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="checkbox" name="eligible_for_rehire" class="onoffswitch1-checkbox" value="On" id="myonoffswitch1" tabindex="0" checked>
                  ...
                  <div class="form-group">
                    ...
                    <input type="checkbox" name="notice_given" class="onoffswitch3-checkbox" value="On" id="myonoffswitch3" tabindex="0" checked>
    ...
    <div class="col-lg-6">
              <div class="form-group">
                    ...
                    <div class="col-lg-9" style="margin-top: 5px;">
                         {!! Form::textarea('reason', null, ['maxlength'=>'255','placeholder' => 'Reason', 'required'=>true,'rows' => 8, 'cols' => 54, 'class'=>'form-control']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-lg-3 control-label" style="margin-top: 5px;">Further Detail</label>
                    <div class="col-lg-9" style="margin-top: 5px;">
                        {!! Form::text('further_detail', null, ['maxlength'=>'255','placeholder' => 'Further Detail', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9" style="margin-top: 5px;">
                        {!! Form::text('notice_period', null, ['maxlength'=>'255','placeholder' => 'Notice Period', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
    <div class="col-lg-12"><hr>
      @if(count($separationTermnationData) > 0)
            <input type="submit" disabled="disabled" value="Schedule Terminated" class="btn btn-success btn-sm">
            @else()
            <input type="submit" name="" value="Schedule Terminated" class="btn btn-success btn-sm">
            @endif
           <a href="{{route('separation.index')}}"><input type="button" name="" value="Back"  class="btn btn-success btn-sm"></a>
        </div>
  </form>
  </div>
   <hr>
  ...
  <tr>
    ...
    <td>{{$val3->DataGet ? $val3->DataGet->separation_type : 'NA'}}</td>
    <td>{{$val3->termination_date}}</td>
    <td>{{$val3->last_day_worked}}</td>
    <td>{{$val3->further_detail}}</td>
    <td>{{$val3->notice_period}}</td>
     <td style="text-align: center;">
     <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('separation.delete',['id'=>$val3->id])}}"> <button class="" style="background-color: #ebdc34;border: 2px solid #ebdc34;">Delete</button></td></a>
  </tr>@endforeach
</table>
  </div>
                    </div>
