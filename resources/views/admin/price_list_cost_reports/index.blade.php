        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Price List Costs Report</h3>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 no-padding-h table-responsive">
                    <form action="{{ route('price-list-costs-reports.index') }}" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-3 ">
                                ...
                                <a href="{{route('price-list-costs-reports.index')}}" class="btn btn-success"><i class="fas fa-eraser"></i> Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
