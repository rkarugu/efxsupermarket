        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="box-title"> Expired Fuel LPOs </h3>
                </div>
            </div>
                    ...
                    <form action="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a class="btn btn-success" href="{!! route('fuel-lpos.expired') !!}"><i class="fas fa-eraser"></i> Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach($lpos as $index => $lpo)
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="expired_lpos[]" value="{{$lpo->id}}" form="unblock_selected_form">
                                    </td>
                                </tr>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9" class="text-right">
                                    <form id="unblock_selected_form" action="{{ route('reactivate-expired-lpos') }}" method="POST">
                                        @csrf
                                        <button type="submit" id="approve_button" class="btn btn-success btn-sm" disabled><i class="fas fa-thumbs-up"></i> Reactivate Selected</button>
                                    </form>
                                </td>
                            </tr>
                        </tfoot>
...
@section('uniquepagescript')
    ...
    $('input[name="expired_lpos[]"]').on('change', function() {
        if ($('input[name="expired_lpos[]"]:checked').length > 0) {
