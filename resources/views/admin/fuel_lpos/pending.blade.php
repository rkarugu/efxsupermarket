        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="box-title"> Pending Fuel LPOs </h3>
                </div>
            </div>
...
{{-- 
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a class="btn btn-success" href="{!! route('fuel-lpos.pending') !!}"><i class="fas fa-eraser"></i> Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <thead>
                                    ...
                                    <td>
                                        <div class="action-button-div">
                                            @if ($permission == 'superadmin' || isset($permission['pending-fuel-lpos___view']))
                                                <a href="{{route('fuel-lpos.pending.details', $lpo->id)}}" title="view details"><li class="fas fa-eye"></li></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
                        ...
                        {{-- <tr>
                            <th style="text-align: right;" colspan="16">
                                <input type="submit" value="Verify Selected" class="btn btn-primary">
                            </th>
                        </tr> --}}
                    </tfoot>
                </table>
