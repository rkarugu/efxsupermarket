            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!!Form::select('wa_sub_account_section_id', getSubAccountSectionDropdown(), null, ['class' => 'form-control wa_sub_account_section','required'=>true,'placeholder' => 'Please select account' ,'id'=>'selector_selects2' ])!!}
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('account_code', null, ['maxlength'=>'255','placeholder' => 'Account Code', 'required'=>true, 'class'=>'form-control numberwithhifun']) !!}
                        </div>
                    </div>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            {!!Form::select('branches[]', $branches, null, ['class' => 'form-control selector_selects2','required'=>true,'multiple'=>true  ])!!}
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                             <input type="checkbox" name="parent_group" id="is_parent" value="1">
                        </div>
                    </div>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                             ...
                             {!!Form::select('parent_id', ['0'=>'Select Parent']+$lists, null, ['class' => 'form-control selector_selects2 parent_selectable','required'=>true  ])!!}
                        </div>
                    </div>
                </div>
