        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Daily Moves Report</h3>
                </div>
            </div>
            ...
            <div class="box-header with-border no-padding-h-b">
                ...
                <div class="col-md-12 no-padding-h table-responsive">
                    <form action="{{ route('salesVsMovesReport.index') }}" method="GET">
                        <div class="row">
                            <div class="col-md-3 form-group">
                                ...
                                <select name="branch" id="mlselec6t" class="form-control mlselec6t" required>
                                    ...
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}" @if (request()->branch == $branch->id)
                                            selected
                                            
                                        @endif>{{ $branch->location_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 form-group">
