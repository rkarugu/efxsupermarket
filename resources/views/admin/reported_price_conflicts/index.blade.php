        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Reported Price Conflicts</h3>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 no-padding-h table-responsive">
                    <form action="{{ route('reported-price-conflicts.index') }}" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-3 ">
                                ...
                                <a href="{{route('reported-price-conflicts.index')}}" class="btn btn-success"><i class="fas fa-eraser"></i> Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
