        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.get-void-orders-reports','method'=>'get']) !!}
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.get-void-orders-reports').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 8%;"  >Price</th>
                                         ...
                                         <th  style="width: 10%;" >Employee Name</th>
                                          <th  style="width: 12%;" >Family Groups</th>
                            ...
                            {!! implode(' ,<br>',$item_desc_array)!!} </td>
                                        ...
                                        <?php 
                                        $emp_name = '-';
                                        if($list->getCancledOrderUserDetail)
                                        {
                                            $emp_name = $list->getCancledOrderUserDetail->name;
                                        }
                                       if($list->getCancledOrderPrintClassUserDetail)
                                        {
                                            $emp_name = $list->getCancledOrderPrintClassUserDetail->name;
                                        }
                                        ?>
                                        ...
                                        <td>{!! $list->order_cancle_reason !!}</td>
