...
@section('content')
    <div class="content">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Missing Items (Stock at Hand = 0, Sales > 0) Report</h3>
            ...
            <div class="box-body">
                <form action="{{ route('inventory-reports.missing-items-report.index') }}" method="get">
        ...
        <div class="box">
            <div class="box-body">
                <table class="table table-bordered" id="missingItemsDataTable">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#missingItemsDataTable").DataTable({
                processing: true,
                serverSide: true,
                scrollX: true,
                scrollY: "600px",
        ...
        function refreshTable() {
            $("#missingItemsDataTable").DataTable().ajax.reload();
        }
    </script>
@endpush
