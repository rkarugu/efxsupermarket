        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Inactive Stock Report (Stock at Hand = 0 , Sales = 0) Report</h3>
            ...
            <div class="box-body">
                <form action="{{ route('inventory-reports.inactive-stock-report.index') }}" method="get">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#inactiveStockDataTable").DataTable({
                ...
                ajax: {
                    url: '{!! route('inventory-reports.inactive-stock-report.index') !!}',
                    data: function(data) {
