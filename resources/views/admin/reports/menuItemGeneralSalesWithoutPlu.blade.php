        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.menu-item-general-sales-without-plu','method'=>'get']) !!}
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.menu-item-general-sales-without-plu').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            </div>
                            </div>
                             ...
                             <div class="col-md-12">
                                <table class="table ">
                                   ...
                                   <tr>
                                        ...
                                        <th width="10%"  >-{!! manageAmountFormat(array_sum($total_disc))!!}</th>
