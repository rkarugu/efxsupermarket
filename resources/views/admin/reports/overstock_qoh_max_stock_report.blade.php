...
@section('content')
    <div class="content">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Overstock Report (QOH > Max Stock) Report</h3>
            ...
            <div class="box-body">
                <form action="{{ route('inventory-reports.overstock-report.index') }}" method="get">
        ...
        <div class="box">
            <div class="box-body">
                <table class="table table-bordered" id="overstockDataTable">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        function refreshTable() {
            $("#overstockDataTable").DataTable().ajax.reload();
        }
    </script>
@endpush
