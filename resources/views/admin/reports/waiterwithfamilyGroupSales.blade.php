        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.waiter-with-family-groups','method'=>'get']) !!}
                            ...
                            <div class="col-sm-3">
                            <div class="form-group">
                            {!!Form::select('user_id', $waiterList, null, ['placeholder'=>'Waiter', 'class' => 'form-control'  ])!!}
                            </div>
                            </div>
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <a class="btn btn-info" href="{!! route('reports.waiter-with-family-groups') !!}"  >Clear </a>
