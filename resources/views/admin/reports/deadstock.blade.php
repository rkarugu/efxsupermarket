...
@section('content')
    <div class="content">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Dead Stock Report (Stock at Hand > 0 , Sales = 0) Report</h3>
            ...
            <div class="box-body">
                <form action="{{ route('inventory-reports.dead-stock-report.index') }}" method="get">
        ...
        <div class="box">
            <div class="box-body">
                <table class="table table-bordered" id="inactiveStockDataTable">
                    <thead>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#inactiveStockDataTable").DataTable({
                processing: true,
                serverSide: true,
                scrollX: true,
                scrollY: "600px",
                ...
                ajax: {
                    url: '{!! route('inventory-reports.dead-stock-report.index') !!}',
                    data: function(data) {
        ...
        function refreshTable() {
            $("#inactiveStockDataTable").DataTable().ajax.reload();
        }
    </script>
@endpush
