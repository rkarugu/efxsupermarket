<table style="width:100%">
    <thead>
        <tr>
            <th style="font-weight: bold" colspan="21">Inactive Stock Report</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th style="font-weight: bold">Last GRN Datel</th>
    ...
    <tbody>
        @foreach ($items as $item)
            <tr>
                ...
                <td>{{ Illuminate\Support\Carbon::parse($item->last_lpo_date)->format('d/m/Y') }}</td>
                <td>{{ Illuminate\Support\Carbon::parse($item->last_grn_date)->format('d/m/Y') }}</td>
                <td>{{ $item->users }}</td>
