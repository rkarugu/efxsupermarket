        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.family-group-sales-with-gl','method'=>'get']) !!}
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.family-group-sales-with-gl').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            ...
                            <div class="col-md-12 no-padding-h">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th width="15%"  > Net Sales % Of Ttl</th>
                                        <th width="10%"  > GL Code</th>
                                        <th width="10%"  > GL Name</th>
                             ...
                             <div class="col-md-12">
                                <table class="table ">
                                   ...
                                   <tr>
                                        ...
                                        <th width="15%"  >{!! manageAmountFormat(array_sum($total_amount))!!}</th>
                                        <th width="15%"  >-{!! manageAmountFormat(array_sum($total_disc))!!}</th>
                                        <th width="15%"  > {!! manageAmountFormat(array_sum($total_amount)-array_sum($total_disc))!!}</th>
                                         <th width="10%"  ></th>
                                         <th width="10%"  ></th>
                                    </tr>
                                    </thead>
