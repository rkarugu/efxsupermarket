...
@section('content')
    ...
    <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <form action="{{route('tyreposition.store')}}" method="POST" class="submitMe">
            {{csrf_field()}}
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add New Tyre Position</h5>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <form  method="POST" class="submitMe">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Tyre Position</h5>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">Title</label>
...
$(function() {
    var table = $('#dataTable').DataTable({
        ...
        @if(isset($permission['tyreposition___create']) || $permission == 'superadmin')
