        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title" style="font-weight:500 !important;"> Stock Debtor Information </h3>
                    <a href="{{ route("stock-debtors.index") }}" role="button" class="btn btn-primary"> Back </a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-8">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$debtor->employee->userRole->title}}
                                </td>
                                <th>
                                    Location
                                </th>
                                <td>
                                    {{$debtor->employee->location_stores->location_name}}
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    {{$debtor->employee->userRestaurent->name}}
                                </td>
                                <th colspan="2">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <table class="table table-bordered" id="datatable">
                    <thead>
                        <tr>
                            <th class="text-right" colspan="6">Opening Balance</th>
                    ...
                    <tfoot>
                        <tr>
                            <th style="text-align: right;" colspan="6">Closing Balance:</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#datatable").DataTable({
                ...
                ajax: {
                    url: '{!! route('stock-debtors.view', $debtor->id) !!}',
                    data: function(data) {
                            ...
                            render: function (data, type, row, meta) {
                                if (type === 'display') {
                                    ...
                                    if (documentNo.includes("SAS")) {
                                        return `<a href="/admin/stock-processing/sales/show/`+row.id+`" title="view" target="_blank">`+documentNo+`</a>`;
                                    }
                                    if (documentNo.includes("SAR")) {
                                        return `<a href="/admin/stock-processing/return/show/`+row.id+`" title="view" target="_blank">`+documentNo+`</a>`;
                                    }
                                }
                                return data;
                            }
