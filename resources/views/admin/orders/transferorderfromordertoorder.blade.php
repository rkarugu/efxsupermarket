        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        <div class="box-header with-border no-padding-h-b">
                            ...
                            {!! Form::hidden('request_type', 'order_to_order') !!}  
                            {!! Form::hidden('to_order_slug', $to_order->slug) !!}
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td colspan="2">{!! $from_order_offer->offer_title !!}</td>
                              </tr>
                              <?php $i++ ;?>
                              @endforeach
                              ...
                              <td><span class="headeingg">To Order #{!! $to_order->id !!}</span>
                               <table style="width: 100%;border-right: none !important;" class="inner_tabel">

                              <?php $i =1;?>
                              @foreach($to_order->getAssociateItemWithOrder as $to_order_item)
                              <tr>
                                <td>{!! $i !!}.</td>
                                <td>{!! $to_order_item->item_title !!}</td>
                              </tr>
                              <?php $i++ ;?>
                              @endforeach

                                @foreach($to_order->getAssociateOffersWithOrder as $to_order_offer)
                              <tr>
                                <td>{!! $i !!}.</td>
                               
                                <td>{!! $to_order_offer->offer_title !!}</td>
                              </tr>
                              <?php $i++ ;?>
                              @endforeach
