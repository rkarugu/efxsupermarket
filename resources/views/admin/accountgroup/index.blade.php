                                    ...
                                    <tr>
                                        ...
                                        <th width="15%"  >Group Name</th>
                                          <th width="15%"  >Section</th>
                                           <th width="15%"  >Sequence In TB</th>
                                            <th width="15%"  >Profit & Loss</th>
{{--                                            <th width="15%"  >Parent Group</th>--}}
                                        ...
                                        @foreach($lists as $list)
                                            ...
                                            <tr>
                                                ...
                                                <td>{!! $list->group_name !!}</td>
                                                 <td>{!! $list->getAccountSection?->section_name !!}</td>
                                                 <td>{!! $list->sequence_in_tb !!}</td>
                                                  <td>{!! $list->profit_and_loss=='Y'?'YES':'NO' !!}</td>
{{--                                                   <td>{!! $list->getParentAccountGroup?$list->getParentAccountGroup->group_name:'-' !!}</td>--}}
