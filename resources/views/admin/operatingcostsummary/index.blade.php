                                    ...
                                    <tbody>
                                        @foreach($lists as $key => $list)
                                            <tr>
                                                ...
                                                <td style="text-align:right !important">{{ manageAmountFormat($list->vehicle_service_cost)}}</td>
                                                <td style="text-align:right !important">{{ manageAmountFormat($list->vehicle_fuel_cost)}}</td>
                                                <td style="text-align:right !important">{{ manageAmountFormat($list->vehicle_other_cost)}}</td>
...
window.onload = function() {
    ...
    var options = {
        data: [{
                ...
                dataPoints: [
                    { label: "Total Cost", y: '{{$grand_total}}' },
                    { label: "Service Cost", y: '{{$total_service_cost}}' },
                    { label: "Fuel Cost", y: '{{$total_fuel_cost}}' },
                    { label: "Other Cost", y: '{{$total_other_cost}}' },
                ]
        }]
    };
    ...
    var chart = new CanvasJS.Chart("chartContainer", {
       ...
       /* subtitles: [{
        ...
        data: [{
            ...
            yValueFormatString: "#,##0",
            dataPoints: <?php echo json_encode($chartPoints, JSON_NUMERIC_CHECK); ?>
        }]
    });
    chart.render();
