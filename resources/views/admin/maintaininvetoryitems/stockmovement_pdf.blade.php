    ...
    <div class="invoice-box">
        <table  style="text-align: center;">
            <tbody>
                ...
                <tr class="top">
                    <td colspan="3" style="    text-align: center;">STOCK CARD</td>
                </tr>
                <tr class="top">
        ...
        <table>
            <thead>
                <tr class="heading">
                    ...
                    <td style="text-align: right" width="10%">Qty In</td>
                    <td style="text-align: right" width="10%">Qty Out</td>
                    <td width="10%">New QOH</td>
            ...
            <tbody>
                ...
                @if(isset($lists) && !empty($lists))
                    @foreach($lists as $list)                        
                        <tr class="item">
                            ...
                            <td style="text-align: right">{!! number_format($list->qauntity) !!}</td>
                            ...
                            <td style="text-align: right">{!! manageAmountFormat(@$list->selling_price) !!}</td>
                ...
                <tfoot>
                    <tr class="item" style="">
                        <td colspan="3" style="border-top:2px solid #000;text-align: right"><b>QTY Bf</b></td>
