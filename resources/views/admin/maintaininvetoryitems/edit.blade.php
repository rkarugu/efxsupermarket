            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::select('item_sub_category_id', [$row->item_sub_category_id => @$row->sub_category->title], null, [
                                'maxlength' => '255',
                                'placeholder' => 'Please select',
                                'required' => true,
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::select('suppliers[]', $suppliers, $row->inventory_item_suppliers->pluck('id')->toArray(), [
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::number('standard_cost', null, [
                                'min' => '0',
                                'required' => true,
                                'class' => 'form-control',
                                'id' => 'standard_cost',
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::number('price_list_cost', null, [
                                'min' => '0',
                                'required' => true,
                                'class' => 'form-control',
                                'id' => 'price_list_cost',
                            ...
                            <div class="d-flex">
                                <div class="form-check form-check-inline" style="margin-right:10px;">
                                    <input class="form-check-input" type="radio" name="margin_type" id="marginPercentage"
                                        value="1" @if ($row->margin_type) checked @endif required>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="margin_type" id="marginValue"
                                        value="0" @if (!$row->margin_type) checked @endif>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::number('percentage_margin', null, ['min' => '0', 'required' => true, 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::number('actual_margin', null, [
                                'min' => '0',
                                'required' => true,
                                'class' => 'form-control',
                                'id' => 'actual_margin',
                            ...
                            <div class="d-flex">
                                <div class="form-check form-check-inline" style="margin-right:10px;">
                                    <input class="form-check-input" type="radio" name="status" id="statusActive"
                                        value="1" @if ($row->status) checked @endif required>
                                    <label class="form-check-label" for="statusActive">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="statusRejected"
                                        value="0" @if (!$row->status) checked @endif @if ($row->qoh) disabled @endif>
                            ...
                            <div class="d-flex">
                                <div class="form-check form-check-inline" style="margin-right:10px;">
                                    <input class="form-check-input" type="checkbox" name="statusdecimal"
                                        ...
                                        @if ($row->item_count != null) checked @endif>
                ...
                <div class="box-body">
                    <div class="form-group" id="itemCountGroup"
                        @if ($row->item_count == null) style="display: none" @endif>
            ...
            <div class="box box-primary">
                ...
                <div class="col-md-12 no-padding-h">
                    ...
                    <table class="table table-bordered table-hover assigneditems">
                        ...
                        <tbody>
                            @if ($row->destinated_items->isNotEmpty())
                                @foreach ($row->destinated_items as $key => $item)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="conversion_factor[{{ $key }}]"
                                                class="form-control conversion_factor"
        ...
        /*
                var destinated_item = function(){
                    $(".destination_items").select2({
                        ajax: {
                            url: "{{ route('maintain-items.inventoryDropdown', ['id' => $row->id]) }}",
                            dataType: 'json',
                            type: "GET",
                            data: function (term) {
                                return {
