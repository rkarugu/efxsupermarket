...
@section('content')
    <div class="content">
        <form action="{{ route('credit-debit-notes.store') }}" id="financialNoteForm" method="post"
            enctype="multipart/form-data">
            @csrf()
            <div class="box box-primary">
                <div class="box-header" style="border-bottom: 1px solid #eeee">
                    <h4>Create Debit/Credit Note</h4>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select type="text" class="form-control" id="type" name="type"
                                            ...
                                            <option value="CREDIT">Credit Note (Reduce Supplier Account)</option>
                                            <option value="DEBIT">Debit Note (Increase Supplier Account)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
