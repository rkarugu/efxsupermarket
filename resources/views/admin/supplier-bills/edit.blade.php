...
@section('content')
    <div class="content">
        <form action="{{ route('supplier-bills.update', $bill) }}" id="billsForm" method="post" enctype="multipart/form-data">
            @csrf()
            @method('PUT')
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="supplier" id="supplier" class="form-control"
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}" @selected($supplier->id == $bill->wa_supplier_id)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="cu_invoice_number"
                                            name="cu_invoice_number" data-rule-required="true"
                                            value="{{ $bill->cu_invoice_number }}">
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="bill_date" class="col-sm-3">Bill Date</label>
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" id="bill_date" name="bill_date"
                                            data-rule-required="true" value="{{ $bill->bill_date }}">
                                    </div>
                                    @error('bill_date')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="col-sm-9">
                                        <select name="location" id="location" class="form-control"
                                            ...
                                            @foreach ($branches as $branch)
                                                <option value="{{ $branch->id }}" @selected($branch->id == $bill->location_id)>
                                                    {{ $branch->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="memo" name="memo"
                                            data-rule-required="true" value="{{ $bill->memo }}">
                                    </div>
                                </div>
                                @error('memo')
                                    <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="p-3">
                        <table class="table table-bordered table-striped" id="recordsTable">
                            ...
                            <tbody>
                                @forelse ($bill->items as $key => $item)
                                    <tr class="items">
                                        <td width="30%">
                                            <div class="form-group">
                ...
                <div class="box-footer">
                    <div class="text-right">
                        <a href="{{ route('supplier-bills.index') }}" class="btn btn-primary">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#billsForm").on('change', ".amount", function() {
            ...
            $('#billsForm').on('change', ".vat_taxes", function(e) {
