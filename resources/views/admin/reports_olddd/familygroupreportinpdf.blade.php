...
<table >
  <tr>
    <th colspan="4" style="text-align: center;">{!! $heading !!}</th>
  </tr>
  @if($restro_name != '')
  <tr>
   <td >{!! $restro_name !!}</td>
...
@if($case != 'CONDIMENTSALESREPORTWITHPLU' && $case != 'PAYMENTSALESUMMARY' && $case != 'DISCOUNTREPORTS' && $case != 'CASHIERREPORT' && $case != 'PERCENTAGEPROFITREPORT')
