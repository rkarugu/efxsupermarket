        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.waiter-menu-item-general-sales','method'=>'get']) !!}
                            ...
                            <div class="col-sm-3">
                            <div class="form-group">
                            {!!Form::select('waiter', getwaiterlist(), null, ['placeholder'=>'Waiter', 'class' => 'form-control mlselect'  ])!!}
                            </div>
                            </div>
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.waiter-menu-item-general-sales').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            </div>
                            </div>
