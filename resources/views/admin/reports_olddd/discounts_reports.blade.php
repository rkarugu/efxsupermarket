        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.get-discounts-reports','method'=>'get']) !!}
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.get-discounts-reports').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            ...
                            <div class="col-md-12 no-padding-h">
                                <table class="table table-bordered table-hover">
                                   ...
                                   $total_qty = [];
                                    ...
                                    ?>
                                    @foreach($detail as $discount_name=>$row)
                                    <tr>
                                        <td>{!! $counter !!}</td>
                                        <td>{!! str_replace('_',' ',$discount_name) !!}</td>
                                        <td>{!! $row['no_of_transactions']!!}</td>
                                        <td>{!! manageAmountFormat($row['total_amount']) !!}</td>
                                    </tr>
                                    <?php 
