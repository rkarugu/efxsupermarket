        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.menu-item-general-sales-with-plu','method'=>'get']) !!}
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.menu-item-general-sales-with-plu').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            </div>
                            </div>
