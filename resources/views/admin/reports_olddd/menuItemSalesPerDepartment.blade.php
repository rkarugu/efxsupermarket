        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'reports.menu-item-sales-per-department','method'=>'get']) !!}
                            ...
                            <div class="col-sm-3">
                            <div class="form-group">
                            {!!Form::select('print_class_id', getPrintClassList(), null, ['placeholder'=>'Print Class', 'class' => 'form-control mlselect'  ])!!}
                            </div>
                            </div>
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('reports.menu-item-sales-per-department').getReportDefaultFilter() !!}"  >Clear</a>
                                </div>
                            </div>
                            </div>
