                                ...
                                <form  method="get">
                                        ...
                                        <div class="row top-box">                              
                                            ...
                                            <div class="col-md-3 form-group">
                                                ...
                                                {!!Form::select('vehicle', getVehicleList(),request()->vehicle, ['class' => 'form-control mlselec6t vehicle_list','required'=>true,'id'=>'vehicle' ])!!} 
                                            </div>
                                            <div class="col-md-3">
                                                <div class="btn-div">
                                ...
                                <table class="table table-bordered table-hover" id="create_datatable1">
                                    ...
                                    <tbody>
                                        @foreach($lists as $key => $list)
                                            <tr>
                                                <td>{!! ++$key !!}</td>
                                                <td>{!! $list->fuel_entry_date !!}</td>
                                                <td style="text-align:right !important">{{ $list->fuel_type}}</td>
                                                <td style="text-align:right !important">{{ manageAmountFormat($list->odometer)}}</td>
                                                <td style="text-align:right !important">{{ manageAmountFormat($list->gallons)}}</td>
                                                <td style="text-align:right !important">{{ manageAmountFormat($list->price)}}</td>
                                                <td style="text-align:right !important"> {{ manageAmountFormat($list->total) }} </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfooter>
                                        <tr>
                                            ...
                                            <th class="text-right">{{manageAmountFormat($total_odometer)}}</th>
                                            <th class="text-right">{{manageAmountFormat($total_fuel_economy)}}</th>
                                            <th class="text-right">{{manageAmountFormat($total_price)}}</th>
