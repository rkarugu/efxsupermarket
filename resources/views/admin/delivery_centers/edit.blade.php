        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="box-title"> {{ $center->name }} - Update </h3>
            ...
            <div class="box-body">
                ...
                <form action="{{ route("$base_route.update", $center->id) }}" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {!!Form::select('route_id', $routes, $center->route_id, ['placeholder'=>'Select Route', 'class' => 'form-control', 'id' => 'search-routes', 'required'=>true ])!!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" id="name" placeholder="Delivery center name" value="{{ $center->name }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="center-location" name="center_location_name" class="form-control" placeholder="Search center to prefill coordinates"
                                   value="{{ $center->center_location_name }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="lat" id="lat" value="{{ $center->lat }}" placeholder="Latitude">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="lng" id="lng" value="{{ $center->lng }}" placeholder="Longitude">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="number" class="form-control" name="preferred_center_radius" id="preferred_center_radius"
                                   ...
                                   value="{{ $center->preferred_center_radius }}">
