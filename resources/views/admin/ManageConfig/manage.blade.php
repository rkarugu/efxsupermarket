        ...
        <div class="form-group">
          ...
          <div class="col-lg-9" style="margin-top: 5px;">
           {!!Form::select('non_cash_benefits_id',
            $payment_mode, null, ['placeholder'=>'Select Non-Cash Benefits', 'class' => 'form-control','required'=>true,'title'=>'Please Non-Cash Benefits'  ])!!} 
          </div>
        </div>
        <div class="form-group">
        <label for="inputEmail3" class="col-lg-3 control-label" style="margin-top: 5px;">Year</label>
...
<!--             <th align="left" scope="col" style="width:70px;">&nbsp;</th>
 -->          </tr>
          <tr>
            ...
            <td>&nbsp;</td>
            <td>6000.00</td>
            <td><span><input type="checkbox" name="" disabled="disabled"></span></td>
            <td><span><input type="checkbox" name="" disabled="disabled"></span></td>
<!--             <td><input type="button" value="Edit" onclick="" class="btn btn-success btn-xs"></td>
 -->          </tr>
        </tbody>
      </table>
</div>
