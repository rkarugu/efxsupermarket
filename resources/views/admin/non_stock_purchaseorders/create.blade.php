    ...
    <div class="box box-primary">
      ...
      <form method="POST" action="" accept-charset="UTF-8" class="" enctype="multipart/form-data" novalidate="novalidate">
           ...
           <div class="form-group">
               ...
               <div class="col-sm-7">
                   {!! Form::text('vehicle_reg_no', NULL, ['maxlength'=>'255','placeholder' => '','id'=>'vehicle_reg_no', 'class'=>'form-control']) !!}  
               </div>
           </div>
       </div>
       </div>
{{--
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-7">
                {!! Form::text('lead_man', NULL, ['maxlength'=>'255','placeholder' => '','id'=>'lead_man', 'class'=>'form-control']) !!}  
            </div>
        </div>
    </div>
</div>--}}
<div class = "row">
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-7">
                {!! Form::text('main_note', NULL, ['maxlength'=>'255','placeholder' => '','id'=>'main_note', 'class'=>'form-control']) !!}  
            </div>
        </div>
    </div>
</div>
...
{{--
                   <div class = "row">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-5 control-label">Projects</label>
                        <div class="col-sm-6">
                          <select name="project_id" id="project_id" class="form-control projects" required></select>
                        </div>
                      </div>
                    </div>
                   </div>
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                    <select name="wa_department_id" id="wa_department_id" class="form-control departments" required></select>
                          </div>
                </div>
            </div>
                     </div>
                        ...
                        <div class="box-header with-border no-padding-h-b">
                           ...
                           <h3 class="box-title"> Purchase Order Line</h3>
                            ...
                            <span>
                                ...
                                <button type="button" class="btn btn-success addItemForm" style="margin-bottom:5px" data-toggle="modal" data-target="#modelId">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form action="{{route('addNonStockItem')}}" method="post" class="submitMe">
                        ...
                        {!! Form::hidden('wa_supplier_id', null, ['class'=>'hidden_wa_supplier_id']) !!} 
                        {!! Form::hidden('wa_location_and_store_id', null, ['class'=>'hidden_wa_location_and_store_id']) !!} 
                        {!! Form::hidden('vehicle_reg_no', null, ['class'=>'vehicle_reg_no']) !!} 
                        {{-- {!! Form::hidden('project_id', null, ['class'=>'project_id']) !!}  --}}
                        {!! Form::hidden('wa_department_id', null, ['class'=>'wa_department_id']) !!} 
                        ...
                        <div class="row" style="margin-bottom:10px">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="item_quantity" placeholder="Quantity To purchase">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom:10px">
                            <div class="col-sm-3 " style="padding-top:5px;">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="item_price" placeholder="Price Per Item">
                            </div>
                        </div>
                        ...
                        <br>
                        <button type="submit" id="add-purchase-order" class="btn btn-primary">Save</button>                                                
                    </form>
                </div>
            </div>
        </div>
...
<!--
             ...
             <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label">Item Category</label>
                    <div class="col-sm-9">
                        {!! Form::select('wa_inventory_item_id', getInventoryCategoryList(),null, ['maxlength'=>'255','placeholder' => 'Please select item category', 'required'=>true, 'class'=>'form-control mlselec6t_modal','id'=>'item']) !!}  
                    </div>
                </div>
            </div>
-->
...
$("#wa_department_id").change(function(){
       var wa_department_id = $("#wa_department_id").val();
        $(".wa_department_id").val(wa_department_id);
    });
{{--
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '#add-purchase-order', function(e) {
            e.preventDefault();

            let submitBtn = $(this);
            let originalSubmitBtnText = submitBtn.text();
            let submitForm = submitBtn.closest('form');
            ...
            $.ajax({
                ...
                success: function(response) {
                    form.successMessage('Non-stock item added successfully');
                    setTimeout(() => {
