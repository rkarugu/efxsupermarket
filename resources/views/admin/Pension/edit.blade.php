        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.update',['id'=>$row->id]) }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Pension</label>
                    <div class="col-sm-10">
                        {!! Form::text('pension',$row->pension, ['maxlength'=>'255','placeholder' => 'Pension', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
                   <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="use_rate" class="onoffswitch1-checkbox" value="On" id="myonoffswitch1" tabindex="0" {{$row->use_rate == 'On' ? 'checked="checked"' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="tax_able" class="onoffswitch3-checkbox" value="On" id="myonoffswitch3" tabindex="0" {{$row->taxable == 'On' ? 'checked="checked"' : '' }}>
