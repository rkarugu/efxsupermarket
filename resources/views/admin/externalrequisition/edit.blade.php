                ...
                <div class="form-group">
                  ...
                  <div class = "row">
                            <div class="box-body">
                                ...
                                <div class="col-sm-6">
                                {!!Form::select('store_location_id', getStoreLocationDropdownByBranch($default_branch_id),null, ['class' => 'form-control ','required'=>true,'placeholder' => 'Please select store' ])!!} 
                                </div>
                            </div>
                        </div>
                    </div>
                  <div class = "row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {!!Form::select('wa_supplier_id', getSuppliers(), null, ['class' => 'form-control ','required'=>true,'placeholder' => 'Please select supplier' ])!!} 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class = "row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {!!Form::select('wa_unit_of_measures_id', getUnitOfMeasureList(), $default_unit_of_measures_id, ['class' => 'form-control ','required'=>true,'placeholder' => 'Please select bin location','readonly'=>true ])!!} 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-header with-border no-padding-h-b">
                           ...
                           <h3 class="box-title"> Requisition Line</h3>
                            ...
                            <span id = "requisitionitemtable">
                                      ...
                                      ?>
                                        ...
                                        <td class = "action_crud">
                                                    ...
                                                    <span>
                                                      ...
                                                      <span>
                                                    <a title="Trash" href="{{ route('external-requisitions.items.delete',[$row->purchase_no,$getRelatedItem->id])}}" ><i class="fa fa-trash" aria-hidden="true"></i>
                                                    </a>
                                                    </span>

                                                    <span>
                                                    <a class="left-padding-small" data-href="{!! route('external-requisitions.editPurchaseItem',[ $purchase_no,$getRelatedItem->id]) !!}" onclick="editRequisitionItem('{!! route('external-requisitions.editPurchaseItem',[ $purchase_no,$getRelatedItem->id]) !!}')"  data-toggle="modal" data-target="#edit-Requisition-Item-Model" data-dismiss="modal" ><i class="fa fa-edit" style="color: #444; cursor: pointer;" title="Edit"></i></a></span>
                              ...
                              <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addRequisitionItemModel">Add Item To Requisition</button>
                              </span></div>
                              <div class="col-md-3">
                              @if($row->status == 'UNAPPROVED' && $row->getRelatedItem && count($row->getRelatedItem)>0)
                                 <a href = "{{ route('external-requisitions.sendRequisitionRequest',$purchase_no)}}" class= "btn btn-success btn-lg" >Send Request</a>
                                 @endif
                              </div>
            ...
            <!--div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {!! Form::number('quantity', null, ['min'=>'0', 'required'=>true, 'class'=>'form-control','id'=>'quantity']) !!}  
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                       <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-success btn-sm" style="float: right;">Add</button>
                        </div>
                    </div>
                </div>
            </div> --}}
