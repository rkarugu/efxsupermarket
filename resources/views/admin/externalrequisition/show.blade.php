...
@section('content')
                                ...
                                @if ($row->getRelatedItem && count($row->getRelatedItem) > 0)
                                    ...
                                    @foreach ($row->getRelatedItem as $getRelatedItem)
                                        <tr>
                                            ...
                                            <td class="align_float_left">{{ $getRelatedItem->qoo }}</td>
                                            <td class="align_float_right">{{ $getRelatedItem->quantity }}</td>
                                            <td class="align_float_right">{{ $getRelatedItem->sales }}</td>
                                            <td class="align_float_left">{{ $getRelatedItem->maindata?->re_order_level ?? '' }}</td>
                                            <td class="align_float_left">{{ $getRelatedItem->maindata?->max_stock ?? '' }}</td>
                                    ...
                                    <tr id = "last_total_row">
                                        ...
                                        <td class="align_float_right">
                                            {{ manageAmountFormat(array_sum($total_with_vat_arr)) }}</td>
                                        <td></td>
    ...
    <div class="modal" id="edit-Requisition-Item-Model" class="modal fade" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                {!! Form::select('wa_inventory_item_id', [], null, [
                                    'maxlength' => '255',
