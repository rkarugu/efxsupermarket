    ...
    <div class="box box-primary">
         ...
         {!! Form::model($row, ['method' => 'PATCH','route' => [$model.'.update', $row->slug],'class'=>'validate','enctype'=>'multipart/form-data']) !!}
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('stock_id_code', null, ['maxlength'=>'255','placeholder' => 'Stock ID Code', 'required'=>true, 'class'=>'form-control','readonly'=>true]) !!}  
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('suppliers[]',$suppliers,$row->inventory_item_suppliers?->pluck('id')->toArray(), [ 'class' => 'form-control selector_selects2','required'=>true,'multiple'=>true  ])!!}  
                    </div>
                </div>
            </div>
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::number('standard_cost', null, ['min'=>'0', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::number('minimum_order_quantity', null, ['min'=>'0', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
      ...
      <!--       <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::number('selling_price', null, ['min'=>'0', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div> -->
             <div class="box-body">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('alt_code',null, ['maxlength'=>'100','placeholder' => 'Alt Code', 'required'=>false, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('packaged_volume',null, ['maxlength'=>'100','placeholder' => 'Packaged Volume (metres cubed)', 'required'=>false, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('gross_weight',null, ['maxlength'=>'100','placeholder' => 'Gross Weight (KGs)', 'required'=>false, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('net_weight',null, ['maxlength'=>'100','placeholder' => 'Net Weight (KGs))', 'required'=>false, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>
            ...
            {{-- 
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
    	                    <input type="checkbox" name="showroom_stock" @if($row->showroom_stock=='1') checked="checked" @endif />
                        </div>
                    </div>
                </div> 
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
    	                    <input type="checkbox" name="new_stock"  @if($row->new_stock=='1') checked="checked" @endif />
                        </div>
                    </div>
                </div>  
            --}}
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::number('conversion_rate', null, ['min'=>'0', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
            </div>           
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <br>
                        @if ($row->image)
                        <img width="100px" height="100px;"src="{{ asset('uploads/inventory_items/thumb/'.$row->image) }}">
                        @endif
                    </div>
                </div>
            </div>
