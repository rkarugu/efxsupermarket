        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        <div class="box-header with-border no-padding-h-b">
                            <div class="col-sm-12">
                                <div align="right"> 
                                    <a href="{{route('maintain-items.standard.cost',['block_all'=>true])}}" class="btn btn-warning">Block All</a>
                                    <a href="{{route('maintain-items.standard.cost',['un_block_all'=>true])}}" class="btn btn-danger">Un-Block All</a>
                                </div>
                            </div>
                            <br>
                            @include('message')
                                            ...
                                            <tr>
                                                ...
                                                @if($list->slug != 'mpesa')
                                                 @if(isset($permission[$pmodule.'___edit']) || $permission == 'superadmin')
                                                    <span>
                                                    <a title="Edit" href="{{ route($model.'.edit.standard.cost', $list->slug) }}" ><img src="{!! asset('assets/admin/images/edit.png') !!}" alt="">
                                                    </a>
                                                    </span>
