@php
    function displayDeliveryAndLogisticsPermissions($permissions, $previous_permissions, $level = 0)
    {
        ...
        foreach ($permissions as $title => $permission) {
            ...
            if (isset($permission['children'])) {
                displayDeliveryAndLogisticsPermissions($permission['children'], $previous_permissions, $level + 1);
            }
            echo '</ul>';
            echo '</li>';
        }
    ...
    $permissionsToShow = deliveryAndLogisticsPermissionFunction();
@endphp
                        ...
                        <ul class="permission-list level-0">
                            <li>
                                ...
                                <ul class="permission-children" style="display: none;">
                                    ...
                                    @endforeach
                                    @if (isset($permission['children']))
                                        @php displayDeliveryAndLogisticsPermissions($permission['children'], $previous_permissions, 1) @endphp
                                    @endif
                                </ul>
                            </li>
                        </ul>
