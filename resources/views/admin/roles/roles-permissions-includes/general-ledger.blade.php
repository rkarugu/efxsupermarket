@php
    function displayGeneralLedgerPermissions($permissions, $previous_permissions, $level = 0)
    {
        ...
        foreach ($permissions as $title => $permission) {
            ...
            if (isset($permission['children'])) {
                displayGeneralLedgerPermissions($permission['children'], $previous_permissions, $level + 1);
            }
            echo '</ul>';
            echo '</li>';
        }
    ...
    $permissionsToShow = generalLedgerPermissionFunction();
@endphp
                        ...
                        <ul class="permission-list level-0">
                            <li>
                                ...
                                <ul class="permission-children" style="display: none;">
                                    ...
                                    @endforeach
                                    @if (isset($permission['children']))
                                        @php displayGeneralLedgerPermissions($permission['children'], $previous_permissions, 1) @endphp
                                    @endif
                                </ul>
                            </li>
                        </ul>
