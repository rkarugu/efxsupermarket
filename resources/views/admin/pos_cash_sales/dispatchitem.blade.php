                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                              <input type="number" readonly name="item_qty[{{$item->id}}]" onkeyup="getTotal(this);" onchange="getTotal(this);" data-max="{{$quantity}}" max="{{$quantity}}" class="item_qty form-control" value="{{$quantity}}" aria-describedby="helpId">
                            </div>
                        </td>
                        <td><input type="text" class="form-control entered_qty" name="store_qty_loaded[{{$item->id}}]" data-total-qty={{$quantity}}>
                            <input type="hidden" name="inventory_item_id[{{$item->id}}]" value="{{@$item->item->id}}">
