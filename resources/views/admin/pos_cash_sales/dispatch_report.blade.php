                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-warning" name="request_type" value="PDF"><i
                                    class="fa fa-file-pdf" aria-hidden="true"></i></button>
                            <button type="button" class="btn btn-success" onclick="printMe(this); return false;"
                                name="request_type" value="Print"><i class="fa fa-print" aria-hidden="true"></i></button>
                        </div>
                    </div>
                    <br>
                    <br>
...
">
    ...
    <script>
        ...
        function printMe(input) {
            var url = "{{ route('dispatched_items.report') }}?" + $(input).parents('form').serialize() +
                '&request_type=Print';
            print_this(url);
        }
    </script>
