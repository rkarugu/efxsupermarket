...
<div class="row ">
    ...
    <!-- Main content -->
    <form action="{{route('expense.store')}}" method="post" class="addExpense">
        {{csrf_field()}}
                ...
                <div class="box-header with-border no-padding-h-b">                
                    ...
                    <div class="col-md-8 no-padding-h">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="">TB Reporting Branch</label>                                  
                                    <select class="form-control branches" name="tb_reporting_branch" id="branches">
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-4">
