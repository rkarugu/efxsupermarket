        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="box-title"> Add Fuel Station </h3>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="name" id="name"
                                   placeholder="Fuel station name" required value="{{ old('name') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="location_name" name="location_name" class="form-control"
                                   placeholder="Search location" value="{{ old('location_name') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="number" class="form-control" name="fuel_price" id="fuel_price"
                                   value="{{ old('fuel_price') }}" placeholder="Diesel price" min="0" step="any">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select name="supplier" id="supplier" class="form-control" required>
                                ...
                                @foreach($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}"> {{ $supplier->supplierDetails?->name }} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
