    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"> Delivery Loading Sheet </h3>
            </div>
...
{{--                                    {!!Form::select('vehicle_id', getAssignedVehicles(), null, ['placeholder'=>'Select Vehicle', 'class' => 'form-control mlselect getshiftdata' ,'required'=>true ])!!}--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        ...
                        <div class="col-md-12 no-padding-h">
                            <button type="submit" class="btn btn-warning" name="manage-request" value="pdf">
                    ...
                    {!! Form::open(['route' => 'confirm-invoice.invoice_dispatch_report_profit','method'=>'POST']) !!}
                    {{ csrf_field() }}
                    <div>
                        <div class="col-md-12 no-padding-h">
                            <button type="submit" class="btn btn-success" name="manage-request" value="pdf_profit">
                                <i class="fa fa-file-pdf"></i>
                            </button>
                        </div>
                    </div>
