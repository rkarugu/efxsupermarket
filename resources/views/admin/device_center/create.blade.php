            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="Device Model" id="model" class="form-control" name="model" type="text" aria-required="true">  
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="serial_no" class="col-sm-2 control-label">Serial No.</label>
                        <div class="col-sm-10">
                            <input placeholder="Device Serial No." id="serial_no" class="form-control" name="serial_no" type="text" aria-required="true">  
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="device_no" class="col-sm-2 control-label">Device No.</label>
                        <div class="col-sm-10">
                            <input placeholder="Device Device No." id="device_no" class="form-control" name="device_no" type="text" aria-required="true">  
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary addDevice">Submit</button>
                </div>
            </form>
        </div>
    </div>
