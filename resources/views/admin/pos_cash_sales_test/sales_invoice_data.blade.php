                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <input type="number" name="item_qty[{{$item->id}}]" onkeyup="getTotal(this);" onchange="getTotal(this);" data-max="{{$quantity}}" max="{{$quantity}}" class="form-control" value="{{$quantity}}" aria-describedby="helpId">
                              </div>
                        </td>
                        <td>0.00</td>
