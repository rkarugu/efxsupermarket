		...
		<div class="box-header with-border  no-padding-h-b"><h3 class="box-title"> Details </h3>
			@include('message')
                ...
                <div class="container">
	                ...
	                <form class="validate form-horizontal same-form" role="form" method="POST" action="{{ route($model.'.update',base64_encode($row->id)) }}" enctype = "multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT')}}
                        <div class="card">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" type="number"  id="time_enterval" value="{{$row->time_enterval}}" name="time_enterval"/>
                                                </div>
                                                <div class="col-sm-4">
                                                    <label>&nbsp;</label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" type="number"  id="time_duesoon_threshold" value="{{$row->time_duesoon_threshold}}" name="time_duesoon_threshold"/>
                                                </div>
                                                <div class="col-sm-4">
                                                    <label>&nbsp;</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control" type="number" id="primary_meter_interval" value="{{$row->primary_meter_interval}}" placeholder="Every" name="primary_meter_interval"/>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="exampleInputEmail1">Primary Meter Due Soon Threshold</label><br>
                                            <input class="form-control" placeholder="Every" type="number" id="  primary_meter_duesoon_threshold" value="{{$row->primary_meter_duesoon_threshold}}" name="     primary_meter_duesoon_threshold"/>
                                        </div>
                                    </div>    
