...
@section('content')
    <form method="POST" action="{{ route($model . '.store') }}" accept-charset="UTF-8" class="submitMe addExpense"
        enctype="multipart/form-data" novalidate="novalidate" id="transferForm">
        @csrf
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <div class="box-header-flex">
                        <h3 class="box-title"> Initiate Transfers </h3>
                        <a href="{{ route('n-transfers.index') }}" class="btn btn-primary">{{ '<< ' }} Back</a>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <div class = "col-sm-6">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text('transfer_no', $transfer_no, [
                                            'maxlength' => '255',
                                            'placeholder' => '',
                                            'required' => true,
                                            'class' => 'form-control',
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::date('transfer_date', $transfer_date, [
                                            'maxlength' => '255',
                                            'placeholder' => '',
                                            'required' => true,
                                            'class' => 'form-control',
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text('manual_doc_number', null, [
                                            'maxlength' => '255',
                                            'placeholder' => '',
                                            'required' => false,
                                            'class' => 'form-control',
                        ...
                        <div class = "col-sm-6">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {{-- <select name="restaurant_id" class="form-control mlselec6t" required id="branch" {{ !($isAdmin || !$can_view) ? 'disabled' : '' }}> --}}
                                        <select name="restaurant_id" class="form-control mlselec6t" required id="branch" >
                                            <option value="" disabled>Please select branch</option>
                                            @foreach ($all_sections as $section)
                                                <option value="{{ $section->id }}" {{ $section->id == $user->restaurant_id ? 'selected' : '' }}>
                                                    {{ $section->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('wa_department_id', $department, $user->wa_department_id, [
                                            'class' => 'form-control mlselec6t',
                                            'required' => true,
                                            'placeholder' => 'Please select department',
                                            'id' => 'department',
                                            // !($isAdmin || !$can_view) ? 'disabled' : '' => true,
                                        ]) !!}
                                    </div>
                                </div>
                            </div>
                            @php
                                ...
                                //     $fromstore = $tostore->whereIn('id', [46, 37]);
                                // }else{
                                //     $fromstore = $tostore->where('id', 46);
                                // }
                            @endphp
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('from_strore_location_id', $allFromStore, $user->wa_location_and_store_id, [
                                            'class' => 'form-control mlselec6t',
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::select('to_store_location_id', $allToStore, null, [
                                            'class' => 'form-control mlselec6t',
...
">
    ...
    <script type="text/javascript">
        ...
        $('#process-btn').on('click', function(e) {
            e.preventDefault();
            $("#action").val('process')
            $('#confirmationModal .modal-body').text('Are you sure you want to proceed with the transfer?');
        ...
        $('#save-btn').on('click', function(e) {
            e.preventDefault();
            $("#action").val('save')
            $('#confirmationModal .modal-body').text('Are you sure you want to save the transfer?');
            $('#confirmationModal').modal('show');
        });
        ...
        $('#confirmSubmit').on('click', function(e) {
            ...
            let confirmSubmit = $('#confirmSubmit');
            let processBtn = $('#process-btn');
            let saveBtn = $('#save-btn');

            let originalConfirmSubmitText = confirmSubmit.prop('disabled', true).text('Processing...');
            let originalProcessBtnText = processBtn.prop('disabled', true);
            let originalSaveBtnText = saveBtn.prop('disabled', true);
            ...
            $.ajax({
                ...
                success: function(out) {
                    $('#confirmationModal').modal('hide');
                    confirmSubmit.prop('disabled', false).text('Confirm');
