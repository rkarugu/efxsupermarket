                    ...
                    <div class="box box-primary">
                      <div class="box-header with-border">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="box-title">Pending Inter-Branch  Transfers</h3>
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => $model.'.indexReceive','method'=>'get']) !!}
                                                      ...
                                                      <td>{!! getlocationRowById($list->to_store_location_id)->location_name !!}</td>
                                                       <td>{!! $list->status !!}</td>
                                                        ...
                                                        <td class = "action_crud">
                                                          <span>
                                                            <a title="View" href="{{ route('n-transfers.receiveInterBranchTransferview', $list->id) }}" ><i  class="fa fa-eye"></i>
                                                            </a>
                                                            </span>
