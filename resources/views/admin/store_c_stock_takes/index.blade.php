    ...
    <div class="box box-primary">
        <div class="box-header with-border no-padding-h-b">
            <div align = "right">
                ...
                <a href = "{!! route('admin.store-c-stock-takes.freeze-table')!!}" class = "btn btn-success">Freeze Table</a>
                <?php } ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class = "action_crud">
                                <span>
                                    <a title="Print" href="{{ route('admin.store-c-stock-takes.print-to-pdf', $list->id) }}">
...
@include('admin.store_c_stock_takes.stock_check_popup')
...
<script type="text/javascript">
    ...
    function printStockTakes(id) {
       ...
       {
         jQuery.ajax({
             url: '{{route('admin.store-c-stock-takes.print')}}',
             type: 'POST',
   ...
   $('.wa_location_and_store_id').change(function(e){
       ...
       $.ajax({
           type: "GET",
           url: "{{route('admin.store-c-stock-takes.getCategories')}}",
           data: {
