                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="project" id="project" class="form-control">
                                                ...
                                                @foreach ($projects as $project)
                                                    <option value="{{$project->id}}" {{$project->id == request()->project ? 'selected' : ''}}>{{$project->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="report" id="report" class="form-control">
                                                <option value="Summary" {{'Summary' == request()->report ? 'selected' : ''}}>Summary</option>
                                                <option value="Detailed" {{'Detailed' == request()->report ? 'selected' : ''}}>Detailed</option>                                               
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="purchase_no" id="purchase_no" class="form-control" value="{{request()->purchase_no}}" >
                                            </div>
                                    </div>
                                    <br>
                                    <div class="col-sm-2">
