    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"> Expunged Petty Cash Deposits </h3>
            </div>
            ...
            <div class="box-body">
                    ...
                    <form action="">
                        ...
                        <div class="row d-flex" style="align-items: flex-end">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a class="btn btn-success ml-12" href="{!! route('petty-cash-approvals.expunged-deposits') !!}">Clear </a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <table class="table table-bordered table-hover" id="create_datatable">
                    ...
                    <tbody>
                        @foreach($expungedDeposits as $record)
                            <tr>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6"></td>
                            <td></td>
                            <th style="text-align: right;"> {{ manageAmountFormat($expungedDeposits->sum('amount')) }} </th>
                        </tr>
                    </tfoot>
                </table>
            </div>
