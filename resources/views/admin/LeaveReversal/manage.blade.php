...
<div class="box box-primary">
     ...
     <div class="box-header with-border no-padding-h-b">  <h4>Employee Profile</h4>
                 ...
                 <div class="box box-primary" style="margin-top: 20px;">
                       <div class="box-header with-border no-padding-h-b">
                         <h4>Leave Reversal</h4><hr>
        <form class="validate form-horizontal" action="{{route('Leave.Reversal')}}"
         role="form" method="POST"  enctype = "multipart/form-data">
                        ...
                        <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            <label for="inputEmail3" class="col-lg-3 control-label">Cancelled By</label>
                              <div class="col-lg-9">
                             {!! Form::text('reversal_by', $uData->name,['maxlength'=>'255','placeholder' => 'Cancelled By', 'required'=>true, 'class'=>'form-control']) !!}  
                          </div>
                        </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                          <label for="inputEmail3" class="col-lg-3 control-label">Date Cancelled</label>
                            <div class="col-lg-9">
                           {!! Form::text('date_reversal', null, ['maxlength'=>'255','placeholder' => 'Date Cancelled', 'required'=>true, 'class'=>'form-control datepicker']) !!}  
                        </div>
                      </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                         ...
                         <div class="box-header with-border no-padding-h-b">                            <div class="col-md-12 ">
                                <center>
                                    <span id="MainContent_lblapproved" class="label label-success" style="display:inline-block;color:White;font-family:Franklin Gothic Book;font-size:Medium;width:100%;">Leave Reversal
</span></center>
                                <div>
    <table class="table table-striped table-bordered nowrap" cellspacing="0" rules="rows" border="1" id="MainContent_gridapproved" style="border-collapse:collapse;">
        <tbody><tr>
            ...
            <th align="left" scope="col">Date Cancelled</th>
            <th align="left" scope="col">Cancelled By</th>
        </tr>
        @foreach($leaveReversal as $value)
        <tr>
