                 ...
                 <div class="box box-primary" style="margin-top: 20px;">
                       <div class="box-header with-border no-padding-h-b">
                        ...
                        <div class="col-lg-6">
                          ...
                          value="{{$data->leave_id}}">
                          <input type="hidden" name="half_day" class="half_day" value="{{$data->half_day}}">
                        ...
                        <div class="col-lg-6" style="margin-top: 15px;">
                             ...
                             <div class="col-lg-9">
                           {!! Form::text('date', $abcd, ['maxlength'=>'255','placeholder' => 'Date', 'required'=>true, 'class'=>'form-control datepicker Date']) !!}   
                        </div>
                        </div>
                        <div class="col-lg-6" style="margin-top: 15px;">
                        ...
                        <div class="col-lg-12" style="margin-top: 20px;">
                            ...
                            <div class="form-group">
                                        ...
                                        <a href="{{route('HrApproval.LeaveLetterPdf')}}?id={{$data->emp_id}}&assignLeaveID={{$data->id}}"><input type="button" name="" value="Print Form"  class="btn btn-default btn-sm"></a>
                                        <a href="{{route('HrApproval.index')}}"><input type="button" name="" value="Back"  class="btn btn-primary btn-sm"></a>
  ...
  <center>
    ...
    <table class="table table-striped table-bordered nowrap" cellspacing="0" rules="rows" border="1" id="MainContent_gridunapproved" style="border-collapse:collapse;">
        ...
        <tr>
            ...
            <td>{{$val3->LeaveDataGet2 ? $val3->LeaveDataGet2->leave_type : 'NA'}}</td>
            <td>{{$val3->reject_date}}</td>
            <td>{{$val3->day_taken}}</td>
            <td>{{$val3->RejectData ? $val3->RejectData->name : 'NA'}}</td>
        </tr>@endforeach
    </tbody></table>
</div>
 </div>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <form action="{{route('ApprovalHr.Leave')}}" method="post" id="contactForm">     
       {{ csrf_field() }}
       <div class="modal-body">
          ...
          <p>
              Total Days Approved:&nbsp;&nbsp;<span id="MainContent_TotalDays1" style="color:CadetBlue;font-weight:bold;"></span>
          </p>
          ...
          <input type="hidden" class="half_day" name="half_day "value="{{$leaveAssignEmp->half_day}}">
          <hr>
