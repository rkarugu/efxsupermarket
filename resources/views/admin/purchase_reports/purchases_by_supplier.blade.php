    ...
    <div class="box box-primary">
        <div class="box-header with-border no-padding-h-b">
            <div  style="height: 150px ! important;"> 
                ...
                {!! Form::open(['route' => 'purchases-by-supplier','method'=>'get']) !!}
                ...
                <div>
                    <div class="col-md-12 no-padding-h">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {!!Form::select('supplier', getSupplierDropdown(), null, ['placeholder'=>'All', 'class' => 'form-control'])!!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-info" href="{!! route('purchases-by-supplier') !!}"  >Clear</a>
                        </div>
                        </div>
...
<div class="col-sm-12">
        <table class="table table-responsive">
            ...
            <tr>
                <th  colspan="3" ><b>{{$suppliername}}</b></th>
            </tr>
            ...
            <tr style="text-align: left;">
                <td colspan=""><b>Supplier ID</b></td>
                <td colspan=""> <b>Supplier Name</b></td>
            ...
            <tr style="text-align: left;">
                ...
                ?>
                <td colspan=""><?= isset($row->getSupplier->supplier_code) ? $row->getSupplier->supplier_code : '' ?></td>
                <td colspan=""><?= isset($row->getSupplier->name) ? $row->getSupplier->name : '' ?></td>
...
<table class="table table-responsive">
    <tr>
        <th  colspan="5" ><b>{{$suppliername}}</b></th>
     </tr>
 

    <tr style="text-align: left;">
        <th  colspan="4"><b><?= $title ?></b></th>
    </tr>
    ...
    foreach ($detail as $key => $row_data) {
        ...
        ?>
        <tr style="text-align: left;">
            <td colspan="3"><b><?= $row_data['supplier']->supplier_code . '-' . $row_data['supplier']->name ?></b></td>
        </tr>
        <?php
