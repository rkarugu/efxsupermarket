    ...
    <div class="box box-primary">
        <div class="box-header with-border no-padding-h-b">
            <div  style="height: 150px ! important;"> 
                ...
                {!! Form::open(['route' => 'purchases-by-store-location','method'=>'get']) !!}
                ...
                <div>
                    <div class="col-md-12 no-padding-h">
                        ...
                        <div class="row">
                            <div class="col-sm-2"><label>Cost Centre  </label> </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {!!Form::select('cost_centre', getStoreLocationDropdown(), null, ['placeholder'=>'All', 'class' => 'form-control'])!!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-info" href="{!! route('purchases-by-store-location') !!}"  >Clear</a>
                        </div>
                        </div>
...
<div class="col-sm-12">
        <table class="table table-responsive">
            ...
            <tr>
                <th  colspan="3" ><b>{{$cost_centre_title}}</b></th>
            </tr>
    ...
    <tr style="text-align: left;">
        <td colspan=""><b>Location Code</b></td>
        <td colspan=""> <b>Cost Centre</b></td>
    ...
    <tr style="text-align: left;">
        ...
        ?>
        <td colspan=""><?= isset($row->getStoreLocation->location_code) ? $row->getStoreLocation->location_code : '' ?></td>
        <td colspan=""><?= isset($row->getStoreLocation->location_name) ? $row->getStoreLocation->location_name : '' ?></td>
...
<table class="table table-responsive">
     <tr>
        <th colspan="5" ><b>{{$cost_centre_title}}</b></th>
    </tr>
    ...
    foreach ($detail as $key => $row_data) {
        ...
        ?>
        <tr style="text-align: left;">
            <th colspan="3"><b><?= $row_data['location']->location_code . '-' . $row_data['location']->location_name ?></b></th>
        </tr>
        <?php
