                               ...
                               <form action="{!! route($model.'.store')!!}" method="post" class="submitMe">
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox-inline">
                                            <input type="checkbox" name="canorder" id="canorder" class="" value="1">
                                            <label for="canorder">Can Order</label>
                                        </div>
                                        <div class="checkbox-inline">
                                            <input type="checkbox" name="ctn" id="ctn" class="ctn-checkbox" value="1">
                                            <label for="ctn">CTN</label>
                                        </div>
                                        <div class="checkbox-inline">
                                            <input type="checkbox" name="dzn" id="dzn" class="dzn-checkbox" value="1">
...
<script>
    $(document).ready(function () {
        $('.ctn-checkbox').click(function () {
            if ($(this).is(':checked')) {
                $('.dzn-checkbox').prop('checked', false);
            }
        });

        $('.dzn-checkbox').click(function () {
            if ($(this).is(':checked')) {
                $('.ctn-checkbox').prop('checked', false);
            }
        });
    });
</script>
