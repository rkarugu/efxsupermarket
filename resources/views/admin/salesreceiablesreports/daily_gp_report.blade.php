        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'sales-and-receivables-reports.daily-gp-report','method'=>'get']) !!}
                                ...
                                <table class="table table-bordered table-hover" id="create_datatable1">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%"  >Date</th>
                                         ...
                                         <th width="15%"  >Standard Cost</th>
                                         <th width="10%"  >Margin/Unit</th>
                                         <th width="10%"  >Unit Sold</th>
                                         <th width="30%"  >Total Margin</th>
                                   ...
                                   @foreach($all_item as $datas)
	                                   @foreach($datas->getRelatedItem as $data)
	                                    <tr>     
	                                      ...
	                                      <td>{{ $data->standard_cost }}</td>  
	                                      
	                                      @php
	                                      	$marginunit = ($data->unit_price - $data->standard_cost);
	                                      @endphp                                    
	                                      
	                                      <td>{{ manageAmountFormat($marginunit) }}</td>                                      
	                                      <td>{{ $data->quantity}}</td>                                      
	                                       <td>{{ manageAmountFormat(($marginunit * $data->quantity)) }}</td>  
	                                    </tr>
	                                    <?php $total_amount[] = ($marginunit * $data->quantity); ?>
	                                    @endforeach
	                                @endforeach
                                    </tbody>
