        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'sales-and-receivables-reports.showroom-sales-item','method'=>'get']) !!}
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                          {!!Form::select('wa_customer_id', getCustomersTwoList(),null, ['class' => 'form-control mlselec6t','required'=>true,'placeholder' => 'Please select customer','id'=>'wa_customer_id' ])!!} 
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-hover" id="create_datatable1">
                                    ...
                                    <tr>
                                        ...
                                        <th width="20%"  >Order Date</th>
                                         <th width="20%"  >Sales Invoice No.</th>
                                   ...
                                   @foreach($all_item as $datas)
	                                   @foreach($datas->getRelatedItem as $data)
	                                    <tr>     
	                                      ...
	                                      <td>{{ $datas->sales_invoice_number}}</td>                                      
	                                      <td>{{ ucfirst($datas->getRelatedCustomer->customer_name)}}</td>                                      
