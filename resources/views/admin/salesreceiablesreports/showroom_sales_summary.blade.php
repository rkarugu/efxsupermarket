        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        ...
                        <div  style="height: 150px ! important;"> 
                            ...
                            {!! Form::open(['route' => 'sales-and-receivables-reports.showroom-sales-summary','method'=>'get']) !!}
                                ...
                                <table class="table table-bordered table-hover" id="create_datatable1" width="100%">
                                   ...
                                   ?>
                                    ...
                                    <tfoot style="font-weight: bold;">
                                      ...
                                      <td>{{ manageAmountFormat(abs(array_sum($total_cost))) }}</td>
