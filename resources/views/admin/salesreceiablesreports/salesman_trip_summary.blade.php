        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Salesman Trip Summary Report</h3>
                        ...
                        <div class="col-md-12 no-padding-h">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    {!! Form::select('salesman_id', getAllsalesmanLists(), null, [
                            ...
                            @if ($all_item)
                                @foreach ($all_item as $data)
                                    <tr>
                                        ...
                                        <td>{{ manageAmountFormat(@$data->getInventoryItemDetail->standard_cost) }}</td>
                                        <td>{{ manageAmountFormat(abs($data->item_sold * $data->avg_price)) }}</td>
                                        <td>{{ manageAmountFormat(abs($data->item_sold * @$data->getInventoryItemDetail->standard_cost)) }}
                                        </td>
                                        <td>{{ manageAmountFormat(abs($data->item_sold * $data->avg_price) - abs($data->item_sold * @$data->getInventoryItemDetail->standard_cost)) }}
                                        </td>
                                    </tr>
                                    <?php
