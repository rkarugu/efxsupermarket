        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.update',['id'=>$row->id]) }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Separation Type</label>
                    <div class="col-sm-10">
                        {!! Form::text('separation_type', $row->separation_type, ['maxlength'=>'255','placeholder' => 'Separation Type', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
                   <div class="form-group">
