...
<div id="receipt-main">
    ...
    <div style="margin-top: 20px; text-align: center;">
        <h3 style="margin: 0; padding: 0; font-size: 45px;"> Cash Deposit Receipt </h3>
    </div>
    <br>
    <div class="normal" style="position: relative; width: 100%;">
        ...
        <div style="margin-top: 5px;">
            <div style="position: relative; width: 50%; float: left;"> Cash Amount</div>
            <div style="position: relative; width: 50%; float: left; text-align: right;"> {{ number_format($drop ->un_banked_drop,2 ) }} </div>
            <div style="clear: both;"></div>
        </div>
