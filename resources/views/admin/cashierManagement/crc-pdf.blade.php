...
<div id="receipt-main">
    ...
    <div style="margin-top: 20px; text-align: center;">
        <h3 style="margin: 0; padding: 0; font-size: 45px;"> CRC Receipt </h3>
    </div>
    <br>
    <div class="normal" style="position: relative; width: 100%;">
        <div style="">
            <div style="position: relative; width: 50%; float: left;"> Reference</div>
            <div style="position: relative; width: 50%; float: left; text-align: right;">{{ $crc->reference }} </div>
            <div style="clear: both;"></div>
        </div>
        <br>
        <div style="">
            <div style="position: relative; width: 50%; float: left;"> Time</div>
            <div style="position: relative; width: 50%; float: left; text-align: right;"> {{ $crc->created_at }} </div>
            <div style="clear: both;"></div>
        </div>
        ...
        <div style="margin-top: 5px;">
            <div style="position: relative; width: 50%; float: left;"> CRC Amount</div>
            <div style="position: relative; width: 50%; float: left; text-align: right;"> {{ number_format($crc ->amount,2 ) }} </div>
            <div style="clear: both;"></div>
        </div>
        ...
        <div style="margin-top: 5px; font-weight: bold;">
            ...
            <div style="position: relative; width: 50%; float: left; text-align: right;"> {{ $crc->user -> name }} </div>
