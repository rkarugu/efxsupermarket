    ...
    {   
        ...
        public function getwaiterdetailfromObjectArray($row)
        {
            ...
            $user = (object)array(
                    ...
                    'latitude'=> isset($restro->latitude) ? $restro->latitude : '',
                    'longitude'=> isset($restro->longitude) ? $restro->longitude : '',
                    );
            return $user;
        }
        ...
        protected function updateManageStockMoves($order_id){
            ...
            foreach($order_items as $order_item_key => $order_item_row){
                ...
                $quantity = $order_item_row->item_quantity;
                ...
                foreach($recipe_ingredients as $key => $recipe_ingredient_row) {
                    ...
                    $weight_per_item = $recipe_ingredient_row->weight;
                    $weight = $weight_per_item * $quantity;
