                            ...
                            <div class="col-md-12 no-padding-h">
                               ...
                               <table class="table table-bordered table-hover" id="create_datatable1">
                                ...
                                <tr> 
                                    ...
                                    <td width="10%"  style="text-align: right">Action</td>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="details detailsParent tddHead"  > 
                                     ...
                                     @endif
                                         <td>{!! @$list->supplier_code !!} {!! @$list->supplier->name !!}</td>
                                        ...
                                        <td>
                                            <a href="{{route('edit-ledger.edit',$list->id)}}" class="btn btn-danger">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                            ...
                            <table class="table table-bordered table-sm table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('edit-ledger.bank-trans.edit',$item->id)}}" class="btn btn-danger">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td> 
                                    </tr>                                        
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! $item->amount > 0 ? @manageAmountFormat($item->amount) : '-' !!}</td>
                                         ...
                                         <td>
                                            <a href="{{route('edit-ledger.debtor-trans.edit',$item->id)}}" class="btn btn-danger">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td> 
                                    </tr>                                        
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->suppreference}}</td>
                                         ...
                                         <td>
                                            <a href="{{route('edit-ledger.supplier-trans.edit',$item->id)}}" class="btn btn-danger">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td> 
                                    </tr>                                        
