                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" onclick="deleteThisOp('{{route($model.'.destroy', $row->slug)}}','{{$getRelatedItem->id}}'); return false;">
