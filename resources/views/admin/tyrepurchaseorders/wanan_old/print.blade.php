...
<table style="border: 1px solid;" width="100%">
	<tr>
		...
		<td style="text-align: right">
			<span >
				...
				<b>Total Amount </b>&nbsp; &nbsp; &nbsp; &nbsp; {{ manageAmountFormat(array_sum($sub_total)+array_sum($tax_amount))}}<br>
			</span>
		</td>
	</tr>
	<tr><td colspan="2">
	...
	<tr>
		<td colspan="2" style="margin-top:20px !important;">
			Accounts: &nbsp; &nbsp; &nbsp; &nbsp; .................
		</td>
	</tr>
	<tr>
	 <td colspan="2">
		<table width = "100%"  style="margin-top: 15px;">
			<tr>
	<th  width = "30%" colspan="4" style="text-align:center !important;">----------------------------</th>
	<th  width = "30%" colspan="4" style="text-align:center !important;">----------------------------</th>
	<th  width = "33%" colspan="4" style="text-align:center !important;">----------------------------</th>
	</tr>
	<tr>
		<td  width = "30%" colspan="4" style="text-align:center !important;">Purchase Manager</td>
		<td  width = "30%" colspan="4" style="text-align:center !important;">Head Of Department</td>
		<td  width = "33%" colspan="4" style="text-align:center !important;">Managing Director</td>
	</tr>
	   </table>
    </td>
    <tr>
		<td colspan="2" style="margin-top:20px !important;">
			N.B To be authorised by the managing director.
		</td>
	</tr>
	<tr>
		<td colspan="2" style="margin-top:20px !important;">
