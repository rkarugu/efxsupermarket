...
<section class="content">    
    <div class="box box-primary">
      ...
      <form method="POST" action="" accept-charset="UTF-8" class="" enctype="multipart/form-data" novalidate="novalidate">
            {{ csrf_field() }}
             <?php 
                    $purchase_no = getCodeWithNumberSeries('TYRE PURCHASE ORDERS');
            ...
            <div class = "row">
              ...
              <div class = "col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                         {!!Form::select('restaurant_id', getBranchesDropdown(),$default_branch_id, ['class' => 'form-control ','required'=>true,'placeholder' => 'Please select branch','id'=>'branch'  ])!!} 
                    </div>
                </div>
            </div>
                   </div>
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                         ...
                         {!!Form::select('wa_department_id',getDepartmentsDropdown(), $default_department_id, ['class' => 'form-control departments ','required'=>true,'placeholder' => 'Please select department','id'=>'wa_department_id',  ])!!} 
                    </div>
                </div>
            </div>
                     </div>
                        ...
                        <div class="box-header with-border no-padding-h-b">
                           ...
                           <h3 class="box-title"> Purchase Order Line</h3>
                            ...
                            <span>
                              ...
                              <button type="button" class="btn btn-success addItemForm " style="margin-bottom:5px" data-toggle="modal" data-target="#addRequisitionItemModel" id="addItemForm">Add Multiple Item To Purchase Order</button>
                              </span>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form action="{{route('tyre-purchase-orders.store')}}" method="post" class="submitMe">
                        {{csrf_field()}}
            ...
            {{ csrf_field() }}
               ...
               {!! Form::hidden('purchase_no', $purchase_no, []) !!}  
                {!! Form::hidden('purchase_date', $purchase_date, []) !!} 
                  ...
                  {!! Form::hidden('restaurant_id', null, ['class'=>'hidden_restaurant_id']) !!} 
                  {!! Form::hidden('wa_department_id', null, ['class'=>'hidden_wa_department_id']) !!} 
                  {!! Form::hidden('wa_supplier_id', null, ['class'=>'hidden_wa_supplier_id']) !!} 
                    {!! Form::hidden('wa_location_and_store_id', null, ['class'=>'hidden_wa_location_and_store_id']) !!} 
  ...
  $('.addItemForm').click(function() {
    ...
    $("#wa_department_id").change(function(){
       var wa_department_id = $("#wa_department_id").val();
        $(".hidden_wa_department_id").val(wa_department_id);
    });

    $("#branch").change(function(){
       var restaurant_id = $("#branch").val();
        $(".hidden_restaurant_id").val(restaurant_id);
    });
