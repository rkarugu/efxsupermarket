    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border  no-padding-h-b">
                <h3 class="box-title">VAT Reports</h3>
                @include('message')
            </div>
            <div class="box-body">
                <form method="GET" action="{{ route('vat-report.processed.index') }}">
                    <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
                         ...
                         <div class="col-sm-2">
                            <div class="form-group">
                                <label for="location">Vat Type</label>
                                <select class="form-control" name="tax" id="tax">
                                    <option value="">SELECT ALL</option>
                                    @foreach ($taxes as $tax)
                                        <option value="{{ $tax->id }}"
                                            {{ request()->tax == $tax->id ? 'selected' : '' }}>
                                            {{ $tax->title }} ({{ $tax->slug }})
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <button type="submit" name="action" value="excelvat" class="btn btn-primary">
                                    Excel
                                </button>
                                <button type="submit" name="action" value="pdfvat" class="btn btn-primary">
                                    Print PDF
                                </button>
