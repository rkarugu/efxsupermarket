...
@section('content')
    <form action="{{ route('maintain-customers.route_customer_update', $customer->id) }}" method="post" class="submitMe">
        {{ csrf_field() }}
                    ...
                    <div class="col-md-12 no-padding-h table-responsive">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control"
                                placeholder="Enter Name" aria-describedby="helpId" value="{{ @$customer->name }}">
                        </div>
                        <div class="form-group">
                            <label for="">Phone No</label>
                            <input type="text" name="phone_no" id="phone_no" class="form-control"
                                placeholder="Enter Phone No" aria-describedby="helpId" value="{{ @$customer->phone }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ @$customer->kra_pin }}" type="text" name="kra_pin" id="kra_pin"
                                class="form-control" placeholder="KRA PIN" aria-describedby="helpId">
                        </div>

                        <div class="form-group">
                            <label for="">Town</label>
                            <input type="text" name="town" id="town" class="form-control"
                                placeholder="Enter Town" aria-describedby="helpId" value="{{ @$customer->town }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::checkbox('is_credit_customer', 1, $customer->is_credit_customer, ['id' => 'is_credit_customer', 'class' => 'form-check']) !!}
                        </div>
                        @if($customer ->is_credit_customer)
                            <div class="form-group xyz">
                                <label for="inputEmail3" class="control-label">Credit Limit</label>
                                {!! Form::number('credit_limit', $customer->credit_limit, [
                                         'min' => '0',
                            ...
                            <div class="form-group xyz">
                                ...
                                {!! Form::number('return_limit', $customer->return_limit, [
                                        'min' => '0',
                            ...
                            <div class="form-group xyz">
                                ...
                                {!! Form::select('payment_term_id', paymentTermsList(), $customer->payment_term_id, [
                            ...
                            <div>
                                <select name="center_id" id="center_id" class="form-control">
                                    ...
                                    @foreach ($centers as $center)
                                        <option @if ($center->id == $customer->delivery_centres_id) selected @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="location_name" id="location_name" placeholder="Search location"
                                class="form-control" required value="{{ $customer->location_name }}">
                        </div>

                        <div class="form-group">
                            <label for="lat" class="control-label"> Latitude </label>
                            <input type="text" name="lat" id="lat" placeholder="Latitude" class="form-control"
                                required value="{{ $customer->lat }}">
                        </div>

                        <div class="form-group">
                            <label for="lng" class="control-label"> Longitude </label>
                            <input type="text" name="lng" id="lng" placeholder="Longitude"
                                class="form-control" required value="{{ $customer->lng }}">
                        </div>

                        <button type="submit" class="btn btn-primary">Save</button>
                        <a href="{{ route('customer-centre.show', $customer->customer_id) }}" class="btn btn-primary">Back</a>
                    </div>
                </div>
            </div>
        </section>
...
">
    ...
    <script async
        src="https://maps.googleapis.com/maps/api/js?libraries=maps,places&key={{ $google_maps_api_key }}&callback=initMap"
        defer></script>
    ...
    <script type="text/javascript">
        ...
        async function initMap() {
            google.maps.event.addDomListener(window, 'load', function() {
                let input = document.getElementById('location_name');
                let options = {};
