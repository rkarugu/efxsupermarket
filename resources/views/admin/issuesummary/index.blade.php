                                    ...
                                    <tbody>
                                        @foreach($lists as $key => $list)
                                            <tr>
                                                <td>{!! ++$key !!}</td>
                                                <td>{!! $list->id !!}</td>
                                                <td style="text-align:right !important">{{ $list->resolve}}</td>
                                                <td style="text-align:right !important">{{ $list->summary}}</td>
                                                <td style="text-align:right !important">{{$list->assigned}}</td>
                                                <td style="text-align:right !important"> {{$list->due_date }} </td>
                                                <td style="text-align:right !important"> - </td>
                                                <td style="text-align:right !important"> {{@$list->Vehicle->license_plate }} </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
