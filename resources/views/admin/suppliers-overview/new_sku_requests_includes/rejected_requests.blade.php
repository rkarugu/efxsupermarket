<div style="padding:10px;">
    ...
    <hr>
    <table class="table table-bordered table-hover table-striped" id="rejected_requests_table">
        <thead>
            <tr>
                <th>Date</th>
                <th>Initiated By</th>
        ...
        <tbody>
            @foreach ($sku_requests->filter(fn($sku_request) => $sku_request->status === 'Rejected') as $sku_request)
                <tr>
