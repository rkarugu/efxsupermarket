        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        <div class="box-header with-border no-padding-h-b">
                            ...
                            {!! Form::open(['route' => 'feedback.order','method'=>'get']) !!}
                            ...
                            <div class="col-md-12 no-padding-h">
                                ...
                                <div class="col-sm-1">
                                <a class="btn btn-info" href="{!! route('feedback.order') !!}"  >Clear</a>
                                </div>
                            </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>{!! ucfirst($list->getAssociateUserForFeedback->name) !!}</td>
                                                 <td>{!! $list->getAssociateUserForFeedback->phone_number !!}</td>
                                                   ...
                                                   <td>{!! manageOrderidWithPad($list->getAssociateOrderForFeedback->id) !!}</td>
