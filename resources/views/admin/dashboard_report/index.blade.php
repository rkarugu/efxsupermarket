        ...
        <section class="content">   
          <div class="d-flex">
            <label class="switch">
              ...
              <input type="checkbox" onchange="showDash(this)" @if(isset($show_dashboard)) checked @endif>
...
@if(isset($show_dashboard))
    ...
    <div class="box box-primary">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-red">
          <div class="inner">
            <h3 style="font-size: 14px;">KES {!! $earningStats['last_month']!!}</h3>
            <p>Total Sale</p>
          </div>
          <div class="icon">
            <i class="fa fa-bar-chart"></i>
   ...
   {!! Form::open(['route' => 'dashboard_report.index','method'=>'get']) !!}
          ...
          <div class="box-header with-border">
            ...
            {!!Form::select('sale_transaction_month', $months, date('m'), [ 'class' => 'form-control'  ])!!}
             ...
             <div class="col-lg-3 col-xs-6"> 
              ...
              <div class="col-lg-3 col-xs-6"> <button type = "submit" class="btn btn-success">Get</button></div>
