...
<section class="content">    
            ...
            {{-- <div class = "row">
                    ...
                    <div class = "row">
                      <div class="box-body">
                         <div class="form-group">
                             ...
                             <div class="col-sm-6">
                                  {!!Form::select('to_store_location_id',$allToStore, $user->wa_location_and_store_id, ['class' => 'form-control mlselec6t','id'=>'to_store_location_id' ,'placeholder'=>'Please select','readonly'=>true ])!!} 
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                         {!!Form::select('from_store_location_id',$allToStore, null, ['class' => 'form-control mlselec6t','id'=>'from_strore_location_id' ,'placeholder'=>'Please select' ])!!} 
 ...
 <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modelId_load_orders">
    Import
  </button>
  ...
  <div class="modal fade" id="modelId_load_orders" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Sales Orders</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -23px;">
              <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
          <form id="salesordersitems">
          <table class="table" id="sales_orders">
            <thead>
              <tr>
                <th>Order No.</th>
                <th>Salesman</th>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" onclick="addordersToList()">Add</button>
        </div>
      </div>
    </div>
  </div>
...
$(document).on('keypress',".quantity",function(event) {
  ...
  $(document).on('click','.addExpense',function(e){
    ...
    var items = $('.sales_order_item:checked');
    for (var i = 0; i < items.length; i++) {
        postData.append('sales_order[]', $(items[i]).val());
    }
    var $this = $(this);
    $.ajax({
        url:url,
...
<script src="{{asset('assets/admin/dist/bootstrap-datepicker.js')}}"></script>
  ...
  $(document).click(function(e){
    ...
    $(document).on('click','.addNewrow',function(){
      $('#mainItemTable tbody').append('<tr class="salesorderitemremove"><td><input type="text" class="testIn form-control makemefocus"><div class="textData" style="width: 100%;position: relative;z-index: 99;"></div></td>'
                                    +'<td></td>'
                                    +'<td></td>'
                                    +'<td></td>'
                                    +'<td></td>'
