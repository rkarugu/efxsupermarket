       ...
       <?php 
              ...
              <div class = "row">
                ...
                <div class="form-group">
                   <label for="inputEmail3" class="col-sm-5 control-label">Vehicle Reg No</label>
                    <div class="col-sm-7">
                        {!! Form::text('vehicle_reg_no', $row->vehicle_reg_no, ['maxlength'=>'255','required'=>true, 'class'=>'form-control datepicker','readonly'=>true]) !!}  
                    </div>
                </div>
            </div>
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                         {!!Form::select('wa_supplier_id',getSupplierDropdown(),$row->wa_supplier_id, ['class' => 'form-control  mlselec6t','required'=>true,'id'=>'wa_supplier_id'])!!} 
                    </div>
                </div>
            </div>
                     </div>
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                         {!!Form::select('wa_location_and_store_id',getStoreLocationDropdown(), $row->wa_location_and_store_id, ['class' => 'form-control mlselec6t','required'=>true,'id'=>'wa_location_and_store_id' ])!!} 
                    </div>
                </div>
            </div>
                     </div>
  ...
  @endif
         ...
         {!! Form::model($row, ['method' => 'PATCH','route' => [$model.'.update', $row->slug],'class'=>'validate','enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
              ...
              <input type="hidden" name="wa_location_and_store_id" id="update_location" value="{{$row->wa_location_and_store_id}}">
              <input type="hidden" name="wa_supplier_id" id="update_supplier" value="{{$row->wa_supplier_id}}">
...
<script src="{{asset('assets/admin/bower_components/select2/dist/js/select2.full.min.js')}}"></script>
  <script type="text/javascript">
    $('#wa_supplier_id').change(function(){
      $('#update_supplier').val($(this).val());
    });
    $('#wa_location_and_store_id').change(function(){
      $('#update_location').val($(this).val());
    });
