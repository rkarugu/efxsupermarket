...
@section('content')
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="d-flex justify-content-between">
                    <h4 class="box-title">New Purchase Orders</h4>
                    @if (can('add', $model))
                        <div class="text-right">
                            <a href="{!! route('purchase-orders.create') !!}" class="btn btn-success">
                                <i class="fa fa-plus-circle"></i>
                                Add Purchase Orders</a>
                            <a href="{!! route('non-stock-purchase-orders.create') !!}" class="btn btn-success">
                                <i class="fa fa-plus"></i>
                                Non Stock Purchase</a>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <x-purchase-orders.email-supplier-form template='{!! @$template->body ?? $email_template->template !!}' />
    </section>
@endsection
        ...
        $(document).ready(function() {
            ...
            var table = $("#purchaseOrdersDataTable").DataTable({
                ...
                createdRow: function(row, data, dataIndex) {
                    if (data.sent_to_supplier == '0') { 
                        $(row).addClass('bg-aqua');
                    }
                },
