        ...
        <div class="box box-primary">
            <div class="box-header with-border no-padding-h-b">
                <div align = "right">
                    ...
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#manage-stock-model">Add
                        Stock check File</button>
                    <?php } ?>
                </div>
                <br>
                @include('message')
                            ...
                            @if (isset($lists) && !empty($lists))
                                ...
                                @foreach ($lists as $list)
                                    <tr>
                                        ...
                                        <td>@if ($list->user_id == 1)
                                            System
                                            @else
                                            {{$list->getAssociateUserDetail->name}} 
                                            @endif</td>
                                        ...
                                        <td class = "action_crud">
                                            <span>
                                                <a title="Print"
                                                    href="{{ route('admin.stock-takes.print-to-pdf', $list->id) }}">
                                                    <i aria-hidden="true" class="fa  fa-file-pdf"
                                                        style="font-size: 20px;"></i>
                                                </a>
                                            </span>
                                            {{-- <span>
                                                <a title="Print" href="javascript:void(0)"
                                                    onclick="printStockTakes('{!! $list->id !!}')"><i
                                                        aria-hidden="true" class="fa fa-print" style="font-size: 20px;"></i>
                                                </a>
                                            </span> --}}
                                        </td>
                                    </tr>
            ...
            $(".store_location_id").change(function() {
                $.ajax({
                    ...
                    success: function(data) {
                        $(".wa_unit_of_measures_id").html(new Option('Please Select', '', false,
                            false));
