<div class="modal " id="manage-stock-model" role="dialog" aria-hidden="true" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {!! Form::open(['route' => 'admin.stock-takes.add-stock-check-file','class'=>'validate form-horizontal']) !!}
            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            {!!Form::select('wa_unit_of_measure_id', [], null, ['id'=>'location-input','class' => 'form-control wa_unit_of_measures_id wa_unit_of_measure_id authorization_level','required'=>true])!!} 
                        </div>
                    </div>
                    <div class="row form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">Inventory Category</label>
                        <div class="col-sm-10">
                            {!! Form::select('wa_inventory_category_id[]', getInventoryCategoryList() ,null, ['class'=>'form-control wa_inventory_category_id', 'multiple'=>'multiple']) !!}  
                        </div>
                    </div>                    
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            ?>
                            {!!Form::select('action_add_or_update', $action_arr, 2, ['id'=>'location-input','class' => 'form-control authorization_level','required'=>true])!!} 
                        </div>
                    </div>
                    <div class="row form-group">
