...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">
       Purchase Order Authorization Level Assignment
    </h4>
</div>
<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         {!!Form::select('purchase_order_authorization_level', getAuthorizerLevels(), $row->purchase_order_authorization_level, ['class' => 'form-control authorization_level','required'=>false,'placeholder' => 'Please select'  ])!!} 
                    </div>
                </div>
            </div>
 ...
 $(".authorization_level").change(function(){
  ...
  if(emp_level == "")
  {
    emp_level = '0';
     ...
     jQuery.ajax({
          url: '{{route('admin.purchase.order.authorization.assignment.post')}}',
          type: 'POST',
