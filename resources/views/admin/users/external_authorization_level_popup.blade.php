...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">
       External Authorization Level Assignment
    </h4>
</div>
<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         {!!Form::select('external_authorization_level', getAuthorizerLevels(), $row->external_authorization_level, ['class' => 'form-control authorization_level','required'=>false,'placeholder' => 'Please select'  ])!!} 
                    </div>
                </div>
            </div>
 ...
 $(".authorization_level").change(function(){
  ...
  if(emp_level == "")
  {
    emp_level = '0';
     ...
     jQuery.ajax({
          url: '{{route('admin.external.authorization.assignment.post')}}',
          type: 'POST',
