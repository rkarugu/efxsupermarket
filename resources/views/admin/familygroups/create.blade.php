    ...
    <div class="box box-primary">
        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label">Menu Item Group name</label>
                    <div class="col-sm-9">
                        {!!Form::select('parent_ids[]', @$getParentList, null, ['data-placeholder'=>'Select menu item group ', 'class' => 'form-control select2','required'=>true,'multiple'=>'multiple' ])!!} 
             ...
             <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label">GL Account No</label>
                    <div class="col-sm-9">
             ...
             <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label">Allow Happy Hours ?</label>
                    <div class="col-sm-9">
