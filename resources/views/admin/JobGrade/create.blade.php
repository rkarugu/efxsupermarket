        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('job_grade', null, ['maxlength'=>'255','placeholder' => 'Job Grade', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Min Salary</label>
                    <div class="col-sm-10">
                        {!! Form::text('min_salary', null, ['maxlength'=>'255','placeholder' => 'Min Salary', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Max Salary</label>
                    <div class="col-sm-10">
                        {!! Form::text('max_salary', null, ['maxlength'=>'255','placeholder' => 'Max Salary', 'required'=>true, 'class'=>'form-control']) !!}  
                    </div>
                </div>
                   <div class="form-group">
