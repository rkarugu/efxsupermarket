            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input minlength="2" maxlength="255" placeholder="Device Type Title" required="" class="form-control" name="title" type="text" aria-required="true">  
                        </div>
                    </div>
                </div>    
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary addDeviceType">Submit</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(document).on('click','.addDeviceType',function(e){
        e.preventDefault();

        let processDataBtn = $('.addDeviceType');
