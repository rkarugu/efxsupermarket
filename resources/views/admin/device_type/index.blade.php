                    ...
                    <tbody>
                        @foreach($types as $type)
                            <tr>
                                ...
                                <td class="text-right">
                                    @if (can('edit', $model))
                                        <a href="{{ route($model .'.edit',$type->id) }}" class="" style="margin-left: 10px;"><i class="fas fa-pen"></i></a>
                                    @endif
                                    @if (can('delete', $model))
                                        <button  onclick="deletePop({{$type->id}},'{{$type->title}}')" class="" data-id="{{ $type->id }}" style="border:none;background-color:#fff;color:red;"><i class="fa fa-trash"
                                            aria-hidden="true"></i>
                                        </button>
                                    @endif
                                </td>
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="box-title"> Delete Device Type Category</h3>
