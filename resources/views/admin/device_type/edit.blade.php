...
<section class="content">
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.update',$type->id) }}">
                @csrf
                @method('PATCH')
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="Device Type Title" class="form-control" name="title" type="text" aria-required="true" value="{{ $type->title }}">  
                        </div>
                    </div>
                </div>    
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary editDeviceType">Edit</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(document).on('click','.editDeviceType',function(e){
        e.preventDefault();

        let processDataBtn = $('.editDeviceType');
