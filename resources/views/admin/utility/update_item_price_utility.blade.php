        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title"> Download / Update Selling Price </h3>
                </div>
            </div>
            ...
            <div class="box-body">
                ...
                @endif
                <form id="update-bin-form" action="{{ route('utility.update_item_prices_function') }}" method="post"
                    ...
                    <div class="col-md-6" id="update-button-group">
                        <div class="form-group">
                            ...
                            @if ($logged_user_info->role_id == 1 || isset($my_permissions['utility___update-item-selling-price']))
                                <button type="submit" class="btn btn-primary" name="Update" id="update" value="Update">
                                    <i class="fa-solid fa-pen-to-square"></i> Update
                                </button>
                            @endif
                            @if ($logged_user_info->role_id == 1 || isset($my_permissions['utility___download-item-selling-price']))
                ...
                xhr.onload = function() {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        if (intentValue === 'Download Prices') {
                            ...
                            link.download = `Selling-Price-List.xlsx`;
                            link.click();
