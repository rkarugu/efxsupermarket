        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title"> Top Up Mpesa Debits And Statements </h3>
            ...
            <div class="box-body">
                ...
                <form id="topupForm" action="{{ route('bank-statements.upload-debit-mpesa') }}" method="post" enctype="multipart/form-data">
                    {{ @csrf_field() }}
                    <div class="row">
                ...
                @if($processingUpload)
                    ...
                    <div class="box-body">
                        <form action="{{ route('bank-statements.store-debit-mpesa') }}" method="post">
                            {{ @csrf_field() }}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="statementTable">
                                    ...
                                    <tbody>
                                    @foreach($foundInvoices as $statement)
                                        <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="unfoundTable">
                                    <thead>
                                    <tr>
                                        <td>#</td>
                                        <th>REF</th>
                                    ...
                                    <tbody>
                                    @foreach($unfoundInvoices as $statement)
                                        <tr>
                                            <th style="width: 3%;" scope="row">{{ $loop->index + 1 }}</th>
                                            <td>{{ $statement['REF'] }}</td>
                                            <td>{{ $statement['DATE'] }}</td>
