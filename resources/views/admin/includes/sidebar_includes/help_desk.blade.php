    ...
    <li class="treeview @if (isset($model) &&
        ...
        <ul class="treeview-menu">
            @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk___view']))
                ...
                @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk-tickets___add']))
                    <li class="@if (isset($model) && $model == 'new-tickets') active @endif">
                        <a href="{!! route('help-desk.tickets.create') !!}">
                            <i class="fa fa-circle"></i>
                            New Tickets
                        </a>
                    </li>
                @endif
                @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk-tickets___my-tickets']))
                    <li class="@if (isset($model) && $model == 'my-tickets') active @endif">
                        <a href="{!! route('help-desk.my.tickets') !!}">
                            <i class="fa fa-circle"></i>
                            My Tickets
                        </a>
                    </li>
                @endif
                @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk-tickets___status-tickets']))
                    <li class="@if (isset($model) && $model == 'open-tickets') active @endif">
                        <a href="{!! route('help-desk.tickets.index',['status'=>'Open']) !!}">
                            <i class="fa fa-circle"></i>
                            Open Tickets
                        </a>
                    </li>
                @endif
                @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk-tickets___status-tickets']))
                    <li class="@if (isset($model) && $model == 'development-tickets') active @endif">
                        <a href="{!! route('help-desk.tickets.index',['status'=>'Development']) !!}">
                            <i class="fa fa-circle"></i>
                            Development Tickets
                        </a>
                    </li>
                @endif
                @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk-tickets___status-tickets']))
                    <li class="@if (isset($model) && $model == 'completed-tickets') active @endif">
                        <a href="{!! route('help-desk.tickets.index',['status'=>'Completed']) !!}">
                            <i class="fa fa-circle"></i>
                            Completed Tickets
                        </a>
                    </li>
                @endif
                @if ($logged_user_info->role_id == 1 || isset($my_permissions['help-desk-tickets___status-tickets']))
                    <li class="@if (isset($model) && $model == 'closed-tickets') active @endif">
                        <a href="{!! route('help-desk.tickets.index',['status'=>'Closed']) !!}">
                            <i class="fa fa-circle"></i>
                            Closed Tickets
                        </a>
                    </li>
