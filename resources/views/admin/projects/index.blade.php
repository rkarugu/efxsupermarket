...
<style>
    ...
    <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <form action="{{route('projects.store')}}" method="POST" class="submitMe">
            {{csrf_field()}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">Description</label>
                            <input type="text" name="description" id="editdescription" class="form-control" placeholder="Description" aria-describedby="helpId">
                        </div>
...
$(function() {
    var table = $('#dataTable').DataTable({
        ...
        @if(isset($permission['projects___create']) || $permission == 'superadmin')
