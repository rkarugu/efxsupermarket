...
<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.5/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="box box-primary" style="margin-top: 20px;">
      <div class="box-header with-border no-padding-h-b">
               <h4>REPORTS LEAVES REVERSAL REPORT</h4><hr>
               <form method="get">
                <div class="row">
                  <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                  ...
                  <a href="{{route('ReversalReport.Pdf')}}?leave_type_id={{Request::get('leave_type_id')}}&from={{Request::get('from')}}&to={{Request::get('to')}}"><button title="Export In PDF" type="button" class="btn btn-warning" name="manage-request" value="pdf"><i class="fa fa-file-pdf" aria-hidden="true"></i></button></a>
                  @else()
                   <a href="{{route('ReversalReport.Pdf')}}?leave_type_id={{Request::get('leave_type_id')}}&from={{Request::get('from')}}&to={{Request::get('to')}}"><button disabled="disabled" title="Export In PDF" type="button" class="btn btn-warning" name="manage-request" value="pdf"><i class="fa fa-file-pdf" aria-hidden="true"></i></button></a>
                  @endif
                </div>
              </div>
            </form>
           ...
           <tbody>
            ...
            <th align="left" scope="col">Reversal Date</th>
            <th align="left" scope="col">Reversal By</th>
        </tr>
       @foreach($leaveReversalData as $value)
        <tr>
