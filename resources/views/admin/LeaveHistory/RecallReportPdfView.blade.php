  ...
  <table style="width:100%;font-size: 12px;margin-top: 7px;">
    <tr>
            ...
            <th align="left" scope="col" style="padding: 3px;">Recalls Date</th>
            <th align="left" scope="col" style="padding: 3px;">Recalls By</th>
    </tr>
     @foreach($leaveRecallsDataPdf as $value)
         <tr>
          ...
          <td style="padding: 3px;">{{$value->date_recalled}}</td>
