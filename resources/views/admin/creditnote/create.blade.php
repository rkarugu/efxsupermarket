...
<section class="content">    
    <div class="box box-primary">
      ...
      <form method="POST" action="" accept-charset="UTF-8" class="" enctype="multipart/form-data" novalidate="novalidate">
            {{ csrf_field() }}
             <?php 
                    $credit_note_number = getCodeWithNumberSeries('CREDIT_NOTE');
            ...
            <div class = "row">
              ...
              <div class = "col-sm-6">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-5 control-label">Credit Note No.</label>
                    <div class="col-sm-7">

                   
                        {!! Form::text('credit_note_number',  $credit_note_number , ['maxlength'=>'255','placeholder' => '', 'required'=>true, 'class'=>'form-control','readonly'=>true]) !!}  
                    </div>
                </div>
            </div>
                 </div>
             ...
             <div class = "row">
              ...
              <div class = "row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! Form::date('order_date', $order_date, ['maxlength'=>'255','placeholder' => '', 'required'=>true, 'class'=>'form-control ','id'=>'order_date']) !!}  
                    </div>
                </div>
            </div>
            </div>
      ...
      <div class="modal-body">
         ...
         <form class="validate"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
            {{ csrf_field() }}
              ...
              {!! Form::hidden('credit_note_number', $credit_note_number, []) !!}  
