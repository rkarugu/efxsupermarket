            ...
            <div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('category_id', $familyGroups, $row->getItemCategoryRelation->beer_keg_category_id, ['placeholder'=>'Select family group', 'class' => 'form-control','required'=>true  ])!!} 
                    </div>
                </div>
            </div>
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php
                        $image_url = $row->image?'uploads/beerandkeg/thumb/'.$row->image:'uploads/item_none.png';
                        ?>
