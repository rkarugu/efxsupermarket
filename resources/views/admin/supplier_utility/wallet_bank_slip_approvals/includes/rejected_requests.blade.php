<div style="margin-top: 30px">
    <div class="table-responsive">
        <table class="table table-bordered" id="rejected_bank_slips_table">
            ...
            <tbody>
                @foreach ($wallet_slip_approvals_data->filter(fn($record) => $record->walletsupplierdocumentprocesslog && $record->walletsupplierdocumentprocesslog->updated_status === 'Rejected' && $record->walletsupplierdocumentprocesslog->updated_approve_status === 'Initial') as $record)
                    <tr>
