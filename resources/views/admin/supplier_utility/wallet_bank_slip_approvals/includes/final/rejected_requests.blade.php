<div style="margin-top: 30px">
    <div class="table-responsive">
        <table class="table table-bordered" id="rejected_bank_slips_table">
            ...
            <tbody>
                @foreach ($wallet_slip_approvals_data->filter(fn($record) => $record->approve_status === 'Final') as $record)
                    @foreach ($record->walletsupplierdocumentprocesslogs->filter(fn($item) => $item->updated_status === 'Rejected'
