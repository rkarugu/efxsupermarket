            ...
            <div class="box-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="new_requests_tab">
                        @include('admin.supplier_utility.wallet_bank_slip_approvals.includes.final.new_requests')
                    </div>
                    <div class="tab-pane" id="approved_requests_tab">
                        @include('admin.supplier_utility.wallet_bank_slip_approvals.includes.final.approved_requests')
                    </div>
                    <div class="tab-pane" id="rejected_requests_tab">
                        @include('admin.supplier_utility.wallet_bank_slip_approvals.includes.final.rejected_requests')
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            function handleButtonClick(status, clickedButton, otherButton) {
                ...
                if (selectedIds.length > 0) {
                    ...
                    $.ajax({
                        url: "{{ route('update_wallet_slip_status_final.update') }}",
                        method: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
                            ids: selectedIds,
