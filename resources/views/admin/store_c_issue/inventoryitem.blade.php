    ...
    <div class="modal " id="manage-stock-model" role="dialog" tabindex="-1"  aria-hidden="true" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                 {!! Form::open(['route' => 'store-c-issue.inventory-manage-stock','class'=>'validate form-horizontal']) !!}
        ...
        function getAndUpdateItemAvailableQuantity(input_obj){
            ...
            if(location_id){
                ...
                jQuery.ajax({
                    ...
                    type: 'POST',
                    dataType: "json",
                    data:{location_id:location_id, stock_id_code:stock_id_code,'store_c':'store_c'},
                    headers: {
...
$(function() {
    var table = $('#dataTable').DataTable({
        ...
        "ajax":{
        "url": '{!! route('store-c-issue.inventoryItems') !!}',
                "dataType": "json",
                "type": "POST",
