        ...
        <div class="box-header with-border"><h3 class="box-title"> {!! $title !!} </h3></div>
         ...
         {!! Form::model($row, ['method' => 'PATCH','route' => [$model.'.update', $row->slug],'class'=>'validate','enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
              ...
              <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Rating For</label>
                    <div class="col-sm-10">
                    {!!Form::select('rating_for',['O'=>'Order','R'=>'Restaurant'], null, [ 'class' => 'form-control','required'=>true,  ])!!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                       <input type = "file" name = "image_update" title = "Please select image"  accept="image/*">
                        <img style="background-color: #ff0000" width="100px" height="100px;"src="{{ asset('uploads/ratingtypes/thumb/'.$row->image) }}">
                    </div>
                </div>
            </div>
