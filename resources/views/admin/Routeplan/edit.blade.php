    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border no-padding-h-b">
                <h4>Edit Route Plan</h4>
                <form action="{{ route('edit-route-plan.edit', $routePlan) }}" method="post" class="submitMe">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ $routePlan->total_distance }}" name="total_distance"
                            id="total_distance" class="form-control" placeholder="Distance" aria-describedby="helpId">
                    </div>
                    ...
                    <div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $routePlan->total_time }}" name="total_time" id="total_time"
                                    class="form-control" placeholder="Time" aria-describedby="helpId">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="route_name">Total Fuel</label>
                                <input type="number" value="{{ $routePlan->total_fuel }}" name="total_fuel" id="total_fuel"
                                    class="form-control" placeholder="Fuel" aria-describedby="helpId">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" value="{{ $routePlan->start_time }}" name="start_time" id="start_time"
                                class="form-control" aria-describedby="helpId">
                        </div>

                        <div class="form-group">
                            <label for="route_name">End Time</label>
                            <input type="time" value="{{ $routePlan->end_time }}" name="end_time" id="end_time"
                                class="form-control" aria-describedby="helpId">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 no-padding-h">
                        <table class="table table-bordered table-hover" id="">
                            ...
                            <tbody id="">
                                @if (isset($routePlan) && !empty($routePlan))
                                    <?php $b = 1; ?>
                                    @foreach ($routePlan['routePlanCenter'] as $center)
                                        <tr>

                                            <td>

                                                <label for="delivery_center">{{ $center->centre->name }}</label>
                                            ...
                                            <td>
                                                ...
                                                <label for="delivery_center">{{ $center->duration }}</label>
