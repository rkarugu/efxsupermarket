        ...
        <div class="box-body">
            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">KCB MPESAPaybill</label>
                        <div class="col-sm-10">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type = "file" name = "floor_image" title = "Please select image" required accept="image/*" >
                        </div>
                    </div>
                </div>
