        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title"> Rejected Returns </h3>
                </div>
            </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group" style="margin-top: 25px; ">
                                ...
                                <a href="{{ route('transfers.rejected-returns') }}" class="btn btn-primary ml-12"> Clear </a>
                            </div>
                        </div>
                    </div>
                </form>
...
@section('uniquepagescript')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $("#rejectedDatatable").DataTable({
                processing: true,
                serverSide: true,
                order: [
                    [2, "desc"]
                ...
                ajax: {
                    url: '{!! route('transfers.rejected-returns-datatable') !!}',
                    data: function(data) {
