<div class="col-md-8 dashboard-card">
    ...
    @if (!empty($categories))
        <div id="departmental_performance"></div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const data = categories.map(category => parseFloat(category.total_cost));
                ...
                const options = {
                    ...
                    title: {
                        text: 'Departmental Performance (Current Month)',
                        align: 'center',
                        style: {
                            fontSize: '16px',
                            fontWeight: 'bold'
                    ...
                    tooltip: {
                        y: {
                            formatter: function(val) {
                                return `Total Cost: ${val.toLocaleString()}`;
                            }
                        }
                    },
                    dataLabels: {
                ...
                var chart = new ApexCharts(document.querySelector("#departmental_performance"), options);
                chart.render();
            });
        </script>
    @endif
