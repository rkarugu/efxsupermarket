                                ...
                                <table class="table table-bordered table-hover" id="create_datatable">
                                    ...
                                    <tr>
                                        ...
                                        <th width="15%"  >Tax Value</th>
                                          <th width="25%"  >Input Tax GL Account</th>
                                           <th width="25%"  >Output Tax GL Account</th>
                                        ...
                                        @foreach($lists as $list)
                                            ...
                                            <tr>
                                                ...
                                                <td>{!! ucfirst($list->title) !!}</td>
                                                 <td>{!! ucfirst($list->tax_value) !!}%</td>
                                                 <td>{!! $list->getInputGlAccount?$list->getInputGlAccount->account_code:'-' !!}</td>
                                                 <td>{!! $list->getOutputGlAccount?$list->getOutputGlAccount->account_code:'-' !!}</td>
