...
$(function() {
    var table = $('#dataTable').DataTable({
        ...
        "ajax":{
        "url": '{!! route('non-cash-benfit.Datatables') !!}',
                "dataType": "json",
                "type": "POST",
        ...
        { data: 'non_cash_benefit', name: 'non_cash_benefit', orderable:true },
        { data: 'code', name: 'code', orderable:true },
        { data: 'rate', name: 'rate', orderable:true },
        { data: 'use_rate', name: 'use_rate', orderable:true },
        { data: 'recurring', name: 'recurring', orderable:true },
        { data: 'taxable', name: 'taxable', orderable:true },
