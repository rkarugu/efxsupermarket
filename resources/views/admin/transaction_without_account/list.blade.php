        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title"> Transaction Without Account </h3>
                    <div class="d-flex">
...
<script>
    $(document).ready(function() {
        ...
        $('#generateExcelBtn').on('click',function(){
            location.href=`/admin/transactions-without-account/?print=excel&start_date=`+$("#start_date").val()+`,&end_date=`+$("#end_date").val()
        });
        $("#statementsDataTable").DataTable({
                ...
                pageLength: 100,
                ajax: {
                    url: '{!! route('transactions-without-account.index') !!}',
                    data: function(data) {
