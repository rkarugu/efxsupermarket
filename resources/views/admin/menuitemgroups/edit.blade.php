            ...
            <div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('parent_id', @$getParentList, @$row->getRelativeData->parent_id, ['placeholder'=>'Select Sub Major group ', 'class' => 'form-control select2','required'=>true,'title'=>'Please sub major group '  ])!!} 
                    </div>
                </div>
            </div>
