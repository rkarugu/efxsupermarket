...
@section('content')
    <section class="content">
        {!! Form::open(['url' => route('delivery-notes-invoices.store'), 'method' => 'post', 'class' => 'validate']) !!}
        <div class="box box-primary">
            @include('message')
            <div class="box-header with-border">
                <h4 class="box-title">Post Delivery Invoice</h4>
            </div>
            <div class="box-body">
                <div class = "row">
                    <div class = "col-sm-6">
                        <div class="form-group">
                            <div class="row">
                                <label for="inputEmail3" class="col-sm-5 control-label">GRN No.</label>
                                <div class="col-sm-7">
                                    {!! Form::text('grn_number', $grn->grn_number, [
                                        'maxlength' => '255',
                                        'placeholder' => '',
                                        'required' => true,
                                        'class' => 'form-control',
                                ...
                                <div class="col-sm-7">
                                    <select name="branch" id="branch" class="form-control" disabled>
                                        ...
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}" @selected($branch->id == $grn->purchaseOrder->restaurant_id)>
                                                {{ $branch->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-7">
                                    <select name="location" id="location" class="form-control" disabled>
                                        ...
                                        @foreach ($locations as $location)
                                            <option value="{{ $location->id }}" @selected($location->id == $grn->purchaseOrder->wa_location_and_store_id)>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('vehicle_reg_no', $grn->purchaseOrder->vehicle_reg_no, [
                                        'class' => 'form-control',
                                        'id' => 'vehicle_reg_no',
                                        'required' => true,
                                    ]) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('receive_note_doc_no', $grn->purchaseOrder->receive_note_doc_no, [
                                        'class' => 'form-control',
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="row">
                                <label for="purchase_no" class="col-sm-5 control-label">Purchase No.</label>
                                <div class="col-sm-7">
                                    {!! Form::text('purchase_no', $grn->purchaseOrder->purchase_no, [
                                        'maxlength' => '255',
                                        'placeholder' => '',
                                        'required' => true,
                                        'class' => 'form-control',
                                ...
                                <div class="col-sm-7">
                                    <select name="supplier" id="supplier" class="form-control" disabled>
                                        ...
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}" @selected($supplier->id == $grn->purchaseOrder->wa_supplier_id)>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('supplier_invoice_no', $grn->supplier_invoice_no, [
                                        'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('cu_invoice_number', $grn->cu_invoice_number, [
                                        'class' => 'form-control',
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label for="supplier_invoice_date" class="col-sm-5 control-label">Invoice Date</label>
                                <div class="col-sm-7">
                                    {!! Form::date('supplier_invoice_date', null, [
                                        'class' => 'form-control',
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @foreach ($grn->purchaseOrder->purchaseOrderItems as $item)
                            <tr>
                                <td>{{ $item->item_no }}</td>
