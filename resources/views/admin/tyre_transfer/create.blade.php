                                                ...
                                                @foreach($tyre_serials as $key => $serial)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{ Form::select('new_vehicle['.$serial->id.']', getVehicleList(),null, ['class' => 'form-control mlselec6t','placeholder' => 'Please select','id'=>'new_vehicle' ]) }}
                                                        </td>
