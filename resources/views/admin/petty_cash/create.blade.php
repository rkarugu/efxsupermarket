...
<div class="row ">
    ...
    <!-- Main content -->
    <form action="{{route('petty-cash.store')}}" method="post" class="addExpense">
        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  <select name="wa_bank_account_id" class="form-control payment_account"></select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  <select name="payment_method_id" class="form-control payment_method"></select>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover categoryTable" >
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th> Collected By </th>                                    
                                    <th> Amount </th>
                                    <th> <button class="btn btn-primary newItem" data-id="0"> <i class="fa fa-plus" aria-hidden="true"></i> </button> </th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
...
function printBill(slug)
    {
        ...
        $(document).on('click','.newItem',function(e){
            ...
            // $('.name_name').attr('name','name['+newItemNo+']');
            ...
            // $(item).find('.receive_from_name').removeClass('receive_from_name');
        ...
        var category_list = function(){
            $(".category_list").select2(
            {
                ...
                ajax: {
                    url: '{{route("petty-cash.category_list")}}?type=petty_cash',
                    dataType: 'json',
                    type: "GET",
                    delay: 250,
                    data: function (params) {
