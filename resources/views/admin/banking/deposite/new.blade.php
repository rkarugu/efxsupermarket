...
<div class="row ">
    ...
    <!-- Main content -->
    <form action="{{route('banking.deposite.save')}}" method="post" class="addbills">
        {{csrf_field()}}
                        ...
                        <table class="table table-bordered table-hover categoryTable w-100" >
                            <thead>
                                <tr>
                                    ...
                                    <th style="max-width: 5%"> <button class="btn btn-primary newItem" data-id="0"> Add Items </button> </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td style="max-width: 10%">
                                        <select class=" form-control selectsupplier" name="receiver[0]" >
                                        </select>
                                    </td>
                                    <td  style="max-width: 10%">
                                        <select class=" form-control category_list" name="account[0]" >
                                        </select>
                                    </td>
                                    ...
                                    <td  style="max-width: 10%">
                                        <select class=" form-control payment_method" name="payment_method[0]" >
                                        </select>
                                    </td>
                                    <td  style="min-width: 100px;">
                                        <input type="text" placeholder="Ref No" name="ref_no[0]" class="form-control ref_no">
                                    </td>
                                    <td  style="min-width: 100px;">
