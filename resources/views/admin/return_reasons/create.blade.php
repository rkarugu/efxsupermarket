    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="box-title"> Create Return Reasons  </h3>            
        ...
        {{-- @include('message') --}}
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route('return-reasons.store') }}" enctype = "multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('reason', null, ['maxlength'=>'255','placeholder' => 'enter reason', 'required'=>true, 'class'=>'form-control']) !!}  
