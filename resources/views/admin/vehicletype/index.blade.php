...
@section('content')
    ...
    <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <form action="{{route('vehicletype.store')}}" method="POST" class="submitMe">
            {{csrf_field()}}
...
$(function() {
    var table = $('#dataTable').DataTable({
        ...
        @if(isset($permission['vehicletype___create']) || $permission == 'superadmin')
