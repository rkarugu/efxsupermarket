                    ...
                    <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
                        ...
                        <div class="">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 text-left">Users</label>
                                <div class="col-sm-10">
                                    <select name="user" id="user" class="form-contropl select2" required>
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check form-check-inline" style="margin-right:10px;">
                                            <input class="form-check-input" type="radio" name="notification"
                                                id="marginPercentage" value="1" required>
