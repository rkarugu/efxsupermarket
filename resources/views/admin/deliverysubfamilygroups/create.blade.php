    ...
    <div class="box box-primary">
        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label">Delivery Family Group name</label>
                    <div class="col-sm-9">
                        {!!Form::select('parent_id', $getParentList, null, ['placeholder'=>'Please select family group', 'class' => 'form-control','required'=>true,'title'=>'Please select family group '  ])!!} 
                    </div>
                </div>
            </div>
