                                ...
                                <table class="table table-bordered table-hover" id="mainItemTable">
                                    ...
                                    @foreach ($data->items as $item)
                                     ...
                                     <tr>                                      
                                        ...
                                        <td>{{@$item->item->getAllFromStockMovesC->sum('qauntity')}}</td>
                                        ...
                                        <td><input style="padding: 3px 3px;" onkeyup="getTotal(this)" onchange="getTotal(this)" type="number" name="item_quantity[{{@$item->wa_inventory_item_id}}]" data-id="{{@$item->wa_inventory_item_id}}" class="quantity form-control" value="{{$item->qty}}"></td>
  ...
  $(document).click(function(e){
    ...
    function fetchInventoryDetails(varia){
      ...
      if(furtherCall == true){
        $.ajax({
          type: "GET",
          url: "{{route('supreme-store-receive.getInventryItemDetails')}}",
          data: {
            'id':$this.data('id'),
          'supreme_store':'supreme_store'
          },
