<div style="margin-top: 30px">
    <div class="table-responsive">
        <table class="table table-bordered" id="approved_bank_slips_table">
            <thead>
                <tr>
                    <th>SUPPLIER</th>
                    <th>AMOUNT</th>
            ...
            <tbody>
                @foreach ($billing_slip_approvals_data->filter(fn($record) => $record->approve_status === 'Final') as $record)
                    @foreach ($record->billingsupplierdocumentprocesslogs->filter(fn($item) => $item->updated_status === 'Approved'
