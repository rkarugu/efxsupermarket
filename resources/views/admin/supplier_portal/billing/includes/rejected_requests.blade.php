<div style="margin-top: 30px">
    <div class="table-responsive">
        <table class="table table-bordered" id="rejected_bank_slips_table">
            ...
            <tbody>
                @foreach ($billing_slip_approvals_data->filter(fn($record) => $record->billingsupplierdocumentprocesslog && $record->billingsupplierdocumentprocesslog->updated_status === 'Rejected' && $record->billingsupplierdocumentprocesslog->updated_approve_status === 'Initial') as $record)
                    <tr>
