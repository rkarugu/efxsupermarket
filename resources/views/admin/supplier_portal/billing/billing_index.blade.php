            ...
            <div class="box-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="new_requests_tab">
                        @include('admin.supplier_portal.billing.includes.new_requests')
                    </div>
                    <div class="tab-pane" id="approved_requests_tab">
                        @include('admin.supplier_portal.billing.includes.approved_requests')
                    </div>
                    <div class="tab-pane" id="rejected_requests_tab">
                        @include('admin.supplier_portal.billing.includes.rejected_requests')
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            function handleButtonClick(status, clickedButton, otherButton) {
                ...
                if (selectedIds.length > 0) {
                    ...
                    $.ajax({
                        url: "{{ route('update_billing_slip_status.update') }}",
                        method: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
                            ids: selectedIds,
