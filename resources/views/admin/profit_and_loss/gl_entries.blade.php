            ...
            <div class="col-md-12 no-padding-h  table-responsive">
                <table class="table table-bordered table-hover" id="create_datatable1">
                      ...
                      $negativeAMount = 0;
                       ...
                       {{-- @if($row->amount != 0) --}}
                         <tr>
							...
							@endif
                            <td>{!! $row->narrative !!}</td>
                            @if($row->transaction_type=="Ingredients Booking" && $row->reference!=""  && $row->amount > 0)
                            <td><a href="{!! route('admin.completed.orders') !!}?order-id={{$row->reference}}">{!! $row->reference !!}</a></td>
                            @else
                            <td>{!! $row->reference !!}</td>
                            @endif
                    ...
                    <tr> 
                                    ...
                                    <td width="10%">{!! manageAmountFormat($positiveAMount) !!}</td>
                                    <td width="10%">{!! manageAmountFormat($negativeAMount) !!}</td>
