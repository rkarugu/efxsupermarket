...
<div class="invoice-box">
    <table  style="text-align: center;">
        <tbody>
            ...
            <tr class="top">
                <th colspan="3"  style="    text-align: center;">Stock Uncompleted Sales (Short)</th>
            </tr>
            <tr class="top">
                <th colspan="1"  style="    text-align: left;">From : {{ @$startDate }}</th>
                <th colspan="1"  style="    text-align: center;">To : {{ @$endDate }}</th>
                <th colspan="1"  style="    text-align: right;">Bin : {{ @$bin }}</th>
            </tr>
		</tbody>        
    </table>
        ...
        <tbody>
            <tr class="heading">
                ...
                @foreach($debtors as $list)
                    <tr class="item">
                        <td style="width: 3%;" scope="row"> {{ $loop->index + 1 }} </td>
                        <td style="text-align: left;">{!! date('Y-m-d',strtotime($list->created_at)) !!}</td>
                        <td style="text-align: left;">{!! $list->document_no !!}</td>
                        <td style="text-align: left;">{!! $list->stock_id_code !!}</td>
                        <td style="text-align: left;">{!! $list->item_title !!}</td>
                        <td style="text-align: left;">{!! $list->uom_title !!}</td>
