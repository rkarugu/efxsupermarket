        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title" style="font-weight:500 !important;"> Uncompleted Sales (Short) Info </h3>
                    <a href="{{ route("stock-uncompleted-sales.index") }}" role="button" class="btn btn-primary"> Back </a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                ...
                <table class="table table-bordered" id="datatable">
                    ...
                    <tbody>
                        @php
                            ...
                            $vatTotal= 0;
                        @endphp
                        @foreach ($debtor->itemsNotProcessed as $item)
                        <tr>
                    ...
                    <tfoot>
                        ...
                        @if (can('process', 'stock-uncompleted-sales'))
                            <tr>
                                ...
                                <td class="text-right">
                                    <form action="{{route('stock-uncompleted.process',$debtor->id)}}" method="POST">
                                        @csrf
                                        <button class="btn btn-primary" type="submit" title="Process"> Process </button>
                                    </form> 
                                </td>
                            </tr>
                        @endif
