<table style="border:1px solid #ddd; width: 100%; margin-top:40px;font-size:13px;">
    ...
    <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <th style="border-bottom:1px solid black !important;border-top:1px solid black !important;" colspan="3">Bin Location : {{@$val['getinventoryitems'][0]['unitofmeasures']['title']}}</th>
            </tr>
             @php 
             $totalqty = 0;
             $totalcost = 0;
            ...
            $totalqty += $storeBiseQty[$value['getstockmoves']['id']];
             $totalcost += ($value['standard_cost'] * $storeBiseQty[$value['getstockmoves']['id']]);
             @endphp
                ...
                <tr>
                    ...
                    <td>{{ number_format($value['standard_cost'] * $storeBiseQty[$value['getstockmoves']['id']],2) }}</td>
                </tr>
                @endforeach
             @php 
