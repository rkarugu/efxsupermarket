        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div style="margin-top: 15px;" v-if="selectedProductId">
                    ...
                    <div class="d-flex flex-column" v-if="selectedItemBom.length === 0">
                ...
                <div style="margin-top: 15px;" v-if="selectedProductId">
                    ...
                    <div class="d-flex flex-column" v-if="selectedItemOperationSteps.length === 0">
    ...
    <script type="module">
        ...
        const app = createApp({
            ...
            computed: {
                ...
                workOrderIsValid() {
                    return this.selectedItem && this.productionQuantity && (this.productionQuantity > 0) && this.selectedLocationStoreId
                }
            },
