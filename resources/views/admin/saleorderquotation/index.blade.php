    ...
    <section class="content">
                                          ...
                                          <td>{{ manageAmountFormat($list->getRelatedItem->sum('total_cost_with_vat'))}}</td>
                                           <td>{!! ucfirst($list->status) !!}</td>
                                                ...
                                                @if($list->order_creating_status == 'pending')
                                                    ...
                                                    @if($list->status == 'open')
                                                    <span>
                                                    <a title="Transfer To Sales Invoice" href="{{ route($model.'.transfer-to-sales-invoice', $list->slug)}}"  onclick="return confirm('Do you really want to transfer ?')">
      ...
      <script type="text/javascript">
       function printBill(slug)
       {
          ...
          {
            jQuery.ajax({
                url: '{{route('proforma-invoice.print')}}',
                type: 'POST',
