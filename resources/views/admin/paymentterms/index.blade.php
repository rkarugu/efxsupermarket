                            ...
                            <div class="col-md-12 no-padding-h">
                                <table class="table table-bordered table-hover" id="create_datatable">
                                    ...
                                    <tr>
                                        ...
                                        <th width="15%"  >Term Code</th>
                                          <th width="20%"  >Description</th>

                                          <th width="20%"  >Following Month On</th>

                                          <th width="15%"  >Due After (Days)</th>
                                    ...
                                    @if(isset($lists) && !empty($lists))
                                        ...
                                        @foreach($lists as $list)
                                            ...
                                            <tr>
                                                ...
                                                <td>{!! $list->term_code !!}</td>
                                                 <td>{!! $list->term_description !!}</td>
                                                  <td>{!! $list->due_after_given_month=='0'?$list->days_in_following_months.'th':'N/A' !!}</td>
                                                   <td>{!! $list->due_after_given_month=='1'?$list->days_in_following_months.' Days':'N/A' !!}</td>
