                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class = "action_crud">
                                <span>
                                    <a title="Print" onclick="print_this('{{ route('admin.opening-balances.stock-counts.deviation-report-pdf', $list->batch_date) }}'); return false;" href="#">
                                        <i aria-hidden="true" class="fa  fa-print" style="font-size: 20px;"></i>
                                    </a>
                                </span>
                                <span>
                                    <a title="Print" href="{{ route('admin.opening-balances.stock-counts.deviation-report-excel', $list->batch_date) }}">
                                        <i aria-hidden="true" class="fa fa-file-excel-o" style="font-size: 20px;"></i>
                                    </a>
                                </span>
                            </td>
                        </tr>
