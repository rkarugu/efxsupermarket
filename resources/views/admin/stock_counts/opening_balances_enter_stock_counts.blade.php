...
<section class="content">
    ...
    <div class="box box-primary">
         {!! Form::model('WaStockCount', ['method' => 'POST','route' => ['admin.opening-balances.stock-counts.enter-update-stock-counts'],'class'=>'validate','enctype'=>'multipart/form-data']) !!}
    ...
    $('document').ready(function(){
        ...
        if(user.role_id == 152){
           ...
           success: function (response) {
            ...
            // updateTableForm();
            jQuery.ajax({
            url: '{{route('admin.opening-balances.stock-counts.enter-stock-counts-form-list')}}',
            type: 'POST',
            //dataType: "json",
