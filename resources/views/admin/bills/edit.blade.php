                                    ...
                                    <div class="col-sm-6">                               
                                        <div class="form-group">
                                            ...
                                            <select class="form-control payment_terms" name="wa_payment_terms" id="wa_payment_terms">
                                                <option value="{{$data->terms->id}}" selected>{{$data->terms->term_code}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                          ...
                                          <input type="date" class="form-control payment_terms" name="bill_date" id="bill_date" value="{{$data->bill_date}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" name="due_date" id="due_date" value="{{$data->due_date}}">
                                        </div>
                                    </div>
                                    {{-- <div class="col-sm-6">
                                        <div class="form-group">
                                          <label for="">Bill No.</label>
                                          <input type="text" name="bill_no" value="{{$data->bill_no}}" class="form-control" placeholder="" aria-describedby="helpId">
                                        </div>
                                    </div> --}}
                                </div>
                            </div>
        ...
        <section class="content" style="padding-top: 0;">
            <div class="box box-primary">
                <div class="box-header with-border no-padding-h-b">  
                    ...
                    <div class="col-md-12 no-padding-h" style="width: 100%; overflow-x: auto;">
                        <div>
                        ...
                        <table class="table table-bordered table-hover categoryTable" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control branches" name="branch[{{$item->id}}]" >
                                            @if ($item->branch)
                                            <option value="{{@$item->branch->id}}" selected>{{$item->branch->name}}</option>
                                            @endif
                                        </select>
                                    </td>
                                    <td style="min-width:100px !important;">
                                        <input type="text" placeholder="Bill No" name="item_bill_no[{{$item->id}}]" class="form-control item_bill_no"  value="{{$item->item_bill_no}}">
                                    </td>
                                    <td>
                    ...
                    <div class="col-md-12" style="text-align: right">
                        <button class="btn btn-danger addbills" data-action="{{route('bills.update')}}" type="submit" style="margin-right: 10px" >Update</button>
                        <button class="btn btn-danger addbills" data-action="{{route('bills.process')}}" type="submit" style="margin-right: 10px" >Process</button>
                    </div>
                </div>
            </div>
        </section>
...
@endif
    ...
    $(document).on('click','.addbills',function(e){
            e.preventDefault();
