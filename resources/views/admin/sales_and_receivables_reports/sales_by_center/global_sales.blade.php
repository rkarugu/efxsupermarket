            ...
            <div class="box-body">
                ...
                <form action="" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <label for="filter" class="control-label"> Select Days </label>
                            <select name="days" id="days" class="form-control">
                                <option value="" selected disabled> Select days</option>
                                <option value="30" @if (request()->days == '30') selected @endif>25</option>
                                <option value="50" @if (request()->days == '60') selected @endif>50</option>
                                <option value="100" @if (request()->days == '90') selected @endif>100</option>>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <a href="{{ route('sales-and-receivables-reports.sales-by-center-global-sales') }}"
                    ...
                    <table class="table table-bordered table-hover" id="create_datatable">
                        ...
                        @isset($data)
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    @foreach ($months as $month)
                                        <td>
                                            {{ isset($item->sales_for_month[$month]) ? number_format($item->sales_for_month[$month], 2) : '0.00' }}
                                            @php
                                                if (isset($item->sales_for_month[$month])) {
                                               $monthlyTotals[$month] += $item->sales_for_month[$month];
                                           }
                        ...
                        <tfoot>
                            <tr style="font-weight: bold">
                                ...
                                <td>{{ number_format($data->sum('sales_amount')) }}</td>
