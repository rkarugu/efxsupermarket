        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Sales  Performance Report</h3>
                        ...
                        @if(isset($data))
                            @foreach ($data as $record)
                                <tr>
                                    ...
                                    <td>{{ number_format(($record->sales_target * $record->total_order_taking_days), 2) }}</td>
                                    <td>
                                    ...
                                    <td>
                                        {{ manageAmountFormat($record->sales_percentage) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
