        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                <div class="d-flex justify-content-between">
                    <h3 class="box-title">Cartons  Report</h3>
                        ...
                        @if(isset($data))
                            ...
                            @foreach ($data as $record)
                                <tr>
                                    ...
                                    <td>{{ number_format(($record->ctn_target * $record->total_order_taking_days), 2) }}</td>
                                    <td>
                                        <a target="blank"
                                    ...
                                    @if ($filterfrequency != null)
                                            {{ manageAmountFormat(floatval($record->ctns) * floatval($filterfrequency)) }}
                                        @else
                                            {{ manageAmountFormat($record->ctns) }}
                                        @endif
                                        </a>
                                    </td>
                                    <td>
                                      @if ($filterfrequency != null)
                                                {{ $record->ctns_percentage * floatval($filterfrequency) }}
                                            @else
                                                {{ number_format($record->ctns_percentage) }}
                                            @endif
