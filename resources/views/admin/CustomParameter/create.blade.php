            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         {{Form::select('parameter_type', array('Earning'=>'Earning','Deduction'=>'Deduction'),null,['class' => 'form-control','required'=>true,'placeholder'=>' ---Select Parameter Type---'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="taxable" class="onoffswitch1-checkbox" value="On" id="myonoffswitch1" tabindex="0" checked>
