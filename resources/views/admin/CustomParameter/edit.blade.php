            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.update',['id'=>$row->id]) }}" enctype = "multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('parameter', $row->parameter, ['maxlength'=>'255','placeholder' => 'Parameter', 'required'=>true, 'class'=>'form-control']) !!}  
                        </div>
                    </div>
                       <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">Parameter Type</label>
                        <div class="col-sm-10">
                         {{Form::select('parameter_type', array('Earning'=>'Earning','Deduction'=>'Deduction'),$row->parameter_type,['class' => 'form-control','required'=>true,'placeholder'=>' ---Select Parameter Type---'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="taxable" class="onoffswitch1-checkbox" value="On" id="myonoffswitch1" tabindex="0" {{$row->taxable == 'On' ? 'checked="checked"' : ''}}>
