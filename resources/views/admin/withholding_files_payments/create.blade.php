    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                @include('message')
                <h4 class="box-title">Create Payment</h4>
            </div>
            <form action="{{ route('withholding-tax-payments.store') }}" method="POST" class="validate-form">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="well">
                                ...
                                <h4 style="margin-bottom: 20px">{{ $file->file_no }}</h4>
                                <p style="margin-bottom: 0"><strong>Amount: </strong></p>
                                <h3 style="margin-top: 0">{{ manageAmountFormat($file->amount) }}</h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
