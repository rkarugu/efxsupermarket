    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h4 class="box-title">Withholding Tax Payments</h4>
                @include('message');
            </div>
            <div class="box-header with-border">
                <form>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $("#paymentVouchersDataTable").DataTable({
                ...
                ajax: {
                    url: '{!! route('withholding-tax-payments.index') !!}',
                    data: function(data) {
            ...
            $('#paymentVouchersDataTable tbody').on('click', '[data-toggle="vouchers"]', function(e) {
                e.preventDefault();
