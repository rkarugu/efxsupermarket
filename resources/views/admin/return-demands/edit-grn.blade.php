                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr v-for="(lineItem, index) in form.lineItems" :key="index">
                                    ...
                                    <td>@{{ form.lineItems[index].reason }}</td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
        ...
        createApp({
            setup() {
                ...
                returns.forEach(returnItem => {
                    let quantity = page == 'Approve' ? returnItem.quantity : returnItem.returned_quantity
                    let sellingPrice = page == 'Approve' ? returnItem.cost : returnItem.grn.invoice_info.order_price
                    ...
                    form.value.lineItems.push({
                        ...
                        quantity: quantity,
                        weight: quantity * returnItem.grn.inventory_item.net_weight,
                        vat_type: returnItem.grn.inventory_item.tax_manager.title,
                        vat_rate: vatRate,
