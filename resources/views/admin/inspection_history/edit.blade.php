            ...
            <input type="file" class="form-control" id="inputEmail3" name="photo">
                ...
                <div class="col-sm-10">
                    <select class="form-control m-bot15" name="group" required="true">         
                        <option value="" >Select Group</option>
                         <option value="active" <?php if(($row->group)=="active") {echo "selected";}?>>Active</option>
                         <option value="inactive" <?php if(($row->group)=="inactive") {echo "selected";}?>>Inactive</option>
                ...
                <div class="col-sm-10">
                    <select class="form-control m-bot15" name="operator" required="true">         
                        ...
                        <option value="active" <?php if(($row->operator)=="active") {echo "selected";}?>>Active</option>
                         <option value="inactive" <?php if(($row->operator)=="inactive") {echo "selected";}?>>Inactive</option>
                ...
                <div class="col-sm-10">
                    <select class="form-control m-bot15" name="ownership" required="true">         
                        <option value="">Select Ownership</option>
                         <option value="active" <?php if(($row->ownership)=="active") {echo "selected";}?>>Active</option>
                         <option value="inactive" <?php if(($row->ownership)=="inactive") {echo "selected";}?>>Inactive</option>
                ...
                <div class="col-sm-10">
                    <select class="form-control m-bot15" name="linked_devices" required="true">         
                        <option value="{{$row->linked_devices}}">Select Linked Devices</option>
                                <option value="active" <?php if(($row->linked_devices)=="active") {echo "selected";}?>>Active</option>
                                <option value="inactive" <?php if(($row->linked_devices)=="inactive") {echo "selected";}?>>Inactive</option>
                        </select>
                    </div>
                </div>
