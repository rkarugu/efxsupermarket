            ...
            <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input minlength="8" maxlength="50" placeholder="IMEI" class="form-control" name="imei" id="imei" type="text" required>  
                        </div>
                    </div>
                </div>    
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary addDeviceSimCard">Submit</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(document).on('click','.addDeviceSimCard',function(e){
        e.preventDefault();

        let processDataBtn = $('.addDeviceSimCard');
