    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('transfers.returns.process_return_pending_approver_2') }}" method="post" id='return-form'>
                    {{ csrf_field() }}
        ...
        $.ajax({
            ...
            $('#loader-on').hide();
             if(result.status === 1) {
                    ...
                    window.location.href = "{{route('transfers.return_list_groups_2')}}";
                }
             if(result.status === 0) {
