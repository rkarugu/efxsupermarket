                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group" style="margin-top: 25px; ">
                                ...
                                <a href="{{ route('transfers.return_list_groups_2') }}" class="btn btn-primary ml-12"> Clear </a>
                            </div>
                        </div>
                    </div>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-button-div">
                                        <a href="{{ route('transfers.return_list_route_2', [$return->route, $return->invoice_date]) }}" title="Approve Return"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
