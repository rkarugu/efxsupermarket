                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border no-padding-h-b">
                            ...
                            <div class="col-md-12 no-padding-h">
                                <form action="{{route('assets.category.update')}}"  method="post"  data-modal="newAsset"  class="addAssetParts">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row" style="margin-bottom:10px">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="category_code" value="{{$data->category_code}}">
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom:10px">
                                        <div class="col-sm-5 " style="padding-top:5px;">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="category_description" value="{{$data->category_description}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom:10px">
                                        ...
                                        <div class="col-sm-7">
                                            <select  name="fixed_asset_id" class="form-control select2Select" value="{{$data->fixed_asset_id}}">
                                                @foreach ($profit_loss as $item)
                                                    <option value="{{$item->id}}" @if ($data->fixed_asset_id == $item->id)   selected @endif>{{$item->account_code}} - {{$item->account_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom:10px">
                                        ...
                                        <div class="col-sm-7">
                                            <select  name="profit_loss_depreciation_id" class="form-control select2Select" >
                                                @foreach ($gl as $item)
                                                    <option value="{{$item->id}}" @if ($data->profit_loss_depreciation_id == $item->id)   selected @endif>{{$item->account_code}} - {{$item->account_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom:10px">
                                        ...
                                        <div class="col-sm-7">
                                            <select  name="profit_loss_disposal_id" class="form-control select2Select" >
                                                @foreach ($gl as $item)
                                                    <option value="{{$item->id}}"  @if ($data->profit_loss_disposal_id == $item->id)   selected @endif>{{$item->account_code}} - {{$item->account_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-bottom:10px">
                                        ...
                                        <div class="col-sm-7">
                                            <select  name="balance_sheet_id" class="form-control select2Select" >
                                                @foreach ($profit_loss as $item)
                                                    <option value="{{$item->id}}"  @if ($data->balance_sheet_id == $item->id)   selected @endif>{{$item->account_code}} - {{$item->account_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success:function(out)
                {
                    ...
                    if(out.result === 1) {
                        ...
                        {
                            setTimeout(() => {
                                location.href = '{{route('assets.category_index')}}';
                            }, 1000);
                        }
					}
                    if(out.result === -1) {
