                        ...
                        <div class="box-header with-border no-padding-h-b">
                            <div class="box-header with-border">
                                <div class="box-header-flex">
                                    ...
                                    <div class="d-flex">
                                        <a class="btn btn-primary mr-xs pull-right ml-2 btn-sm" href="{{route('assets.category.add')}}">Add Category</a>
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
...
$(function() {
    var table = $('#dataTable').DataTable({
        ...
        //       $('.remove-btn').remove();
        //         $(this).append('<a class="btn btn-danger remove-btn mr-xs pull-right ml-2 btn-sm"  style="margin-left:5px" href="{{route('assets.category.add')}}">Add Category</a>');
        //     });
        // },
        columns: [
        ...
        { data: 'category_code', name: 'category_code', orderable:true  },
        { data: 'category_description', name: 'category_description', orderable:true  },
