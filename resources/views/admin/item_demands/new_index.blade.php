        ...
        <div class="box box-primary" v-cloak>
            ...
            <div class="box-body">
                <form action="" method="get">
                    ...
                    <a href="{{route('demands.item-demands.new')}}" class="btn btn-primary" style="margin-top:25px;">Clear</a>
                ...
                <table class="table table-bordered" id="suppliers-table">
                    ...
                    <tbody>
                        <tr v-for="(demand, index) in demands" :key="demand.id">
                            ...
                            <td>@{{ user.user_restaurent.name }}</td>
                            <td>@{{ demand.demand_no }}</td>
                            <td>@{{ demand.get_user.name}}</td>
                            <td>@{{ demand.get_supplier.name }}</td>
                            <td>@{{ demand.get_demand_item.length }}</td>
                            ...
                            <td>
                                <div class="action-button-div">
                                    <a :href="`/admin/n-item-demands/details/${demand.id}`"><i
