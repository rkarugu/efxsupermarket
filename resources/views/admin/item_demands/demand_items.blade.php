        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    <h3 class="box-title"> {{$supplierName}} DELTAS </h3>
                    <a href="{{route('item-demands.index')}}" class="btn btn-primary">{{'<< '}} Back</a>
                </div>
            </div>
                ...
                <table class="table table-bordered" id="create_datatable_25">
                    ...
                    @foreach($demands as $index => $demand)
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($demand->created_at)->format('Y-m-d') }} </td>
