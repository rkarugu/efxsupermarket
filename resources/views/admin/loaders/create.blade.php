    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <div class="box-header-flex">
                <h3 class="box-title"> Create Loader </h3>
         ...
         @include('message')
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route('loaders.store') }}" enctype = "multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('restaurant_id', getRestaurants(), null, ['placeholder'=>'Select Branch ', 'class' => 'form-control','required'=>true,'title'=>'Please select Branch','id'=>'branch'  ])!!}
                    </div>
                </div>
            </div>
