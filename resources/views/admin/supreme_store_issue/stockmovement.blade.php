        ...
        <!-- Small boxes (Stat box) -->
                    <div class="box box-primary">
                        <div class="box-header with-border no-padding-h-b">
                            <div>
                                <form action="{{route('supreme-store-issue.stock-movements',['stockIdCode'=>$StockIdCode])}}" method="get">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <a style="float:right;" class="btn btn-danger" href="{{route('supreme-store-issue.inventoryItems')}}">Back</a>
...
<script>
    ...
    function printStockCard(input) { 
        var url = "{{route('supreme-store-issue.stock-movements',['stockIdCode'=>$StockIdCode])}}?"+$(input).parents('form').serialize()+'&type=print';
        print_this(url);
