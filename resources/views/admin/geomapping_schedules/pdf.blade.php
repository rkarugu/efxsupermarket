    ...
    <div class="invoice-box">
        ...
        <table>
            <thead>
                <tr>
                    <th>#</th>
                    <th  style="width:30%;text-align:left">Branch</th>
                    <th>Routes</th>
                    <th>Centres</th>
            ...
            {{-- <tr class="heading">
                    <th style="width:55%;text-align:left">Pa</th>
                ...
                @foreach ($data as $branch)
                    <tr>
                        ...
                        <th style="text-align: center;">
                            {{ number_format(($branch->geomapped_customer_count / $branch->customer_count) * 100, 2) }}
                        </th>
