                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border no-padding-h-b">
                            ...
                            <div class="col-md-12 no-padding-h table-responsive">
                                <form action="{{route('cheques.pdf')}}" method="post">
                                    {{csrf_field()}}
    ...
    var table = $('#dataTable').DataTable({
        ...
        'fnDrawCallback': function (oSettings) {
            $('.dataTables_filter').each(function () {
              $('.remove-btn').remove();
                $(this).append('<a class="btn btn-danger remove-btn mr-xs pull-right ml-2 btn-sm" style="margin-left:5px" href="{{route('cheques.new')}}">Add</a>');
            });
        },
        columns: [
        ...
        { data: 'cheque_no', name: 'cheque_no', orderable:true },
