        ...
        <div class="box-header with-border"><h3 class="box-title"> {!! $title !!} </h3></div>
         ...
         {!! Form::model($row, ['method' => 'PATCH','route' => [$model.'.update', $row->slug],'class'=>'validate','enctype'=>'multipart/form-data']) !!}
            ...
            <div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Major Group name</label>
                    <div class="col-sm-10">
                        {!!Form::select('parent_id', @$getParentList, @$row->getRelativeData->parent_id, ['placeholder'=>'Select Major group ', 'class' => 'form-control','required'=>true,'title'=>'Please major group '  ])!!} 
                    </div>
                </div>
            </div>
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('restaurant_id', $restaurant, $row->restaurant_id, ['placeholder'=>'Select Branch', 'class' => 'form-control','required'=>true,'title'=>'Please Branch'  ])!!} 
                    </div>
                </div>
            </div>
             <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                       <input type = "file" name = "image_update" title = "Please select image"  accept="image/*">
                        <img width="100px" height="100px;"src="{{ asset('uploads/submajorgroups/thumb/'.$row->image) }}">
                    </div>
                </div>
            </div>
