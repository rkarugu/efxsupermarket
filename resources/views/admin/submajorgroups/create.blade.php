        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('parent_id', $getParentList, null, ['placeholder'=>'Select Major group ', 'class' => 'form-control','required'=>true,'title'=>'Please major group '  ])!!} 
                    </div>
                </div>
            </div>
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!!Form::select('restaurant_id', $restaurant, null, ['placeholder'=>'Select Branch', 'class' => 'form-control','required'=>true,'title'=>'Please Branch'  ])!!} 
                    </div>
                </div>
            </div>
