                    ...
                    <div class="box box-primary" style="margin-top: 20px;">
                       <div class="box-header with-border no-padding-h-b">
                         <h4>Employee Profile</h4><hr>
                          <form class="validate form-horizontal"  role="form" method="POST" action="{{route('SalaryReview.Store')}}" enctype = "multipart/form-data">
                           {{ csrf_field() }}
                        <div class="col-lg-12 col-md-12">
                        <div class="col-lg-6">
                          <input type="hidden" name="emp_id" value="{{$empData->id}}">
                          <div class="form-group">
                            <label for="inputEmail3" class="col-lg-3 control-label" style="margin-top: 5px;">Current Basic Pay</label>
                              <div class="col-lg-9">
                               {!!Form::text('current_basic_pay', $data2->basic_pay, ['placeholder'=>'Current Basic Pay', 'readonly'=>true,'class' => 'form-control','required'=>true  ])!!}
                          </div>
                        </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                          <label for="inputEmail3" class="col-lg-3 control-label" style="margin-top: 5px;">New Basic Pay</label>
                            <div class="col-lg-9">
                            {!!Form::text('new_basic_pay', null, ['placeholder'=>'New Basic Pay', 'readonly'=>false,'class' => 'form-control','required'=>true  ])!!}
                        </div>
                      </div> 
                        </div>
                        <div class="col-lg-6">
                          ...
                          <label for="inputEmail3" class="col-lg-3 control-label" style="margin-top: 5px;">Effective Date</label>
                            <div class="col-lg-9">
                            {!!Form::text('effective_date', null, ['placeholder'=>'Effective Date', 'readonly'=>false,'class' => 'form-control datepicker','required'=>true  ])!!}
                        </div>
                      </div> 
                        </div>
                        <div class="col-lg-6">
                          ...
                          <label for="inputEmail3" class="col-lg-3 control-label" style="margin-top: 5px;">Comment</label>
                            <div class="col-lg-9">
                            {!!Form::text('comment', null, ['placeholder'=>'Comment', 'readonly'=>false,'class' => 'form-control','required'=>true  ])!!}
                        </div>
                      </div> 
                        </div>
                        <div class="col-lg-12">
                      ...
                      <div class="col-lg-12">
                        ...
                        <tbody>
                          <tr style="color:White;background-color:#3AC0F2;">
                            <th scope="col">#</th>
                            <th scope="col">Current Basic Pay</th>
                            <th scope="col">New Basic Pay</th>
...
<!--                             <th scope="col">AbsentPay</th>
 -->                            <th align="left" scope="col" style="width:70px;">&nbsp;</th>
               ...
               @foreach($wa_salaryReviewData as $key => $absentDataVal)
              <tr>
                <td>{{$key+1}}</td>
                <td>{{$absentDataVal->old_pay}}</td>
                <td>{{$absentDataVal->new_basic_pay}}</td>
                <td>{{$absentDataVal->effective_date}}</td>
                <td>{{$absentDataVal->comment}}</td>
