...
@section('content')
<form method="POST" action="{{ route('reverse-splitting.store') }}" accept-charset="UTF-8" class="" onsubmit="return false;" enctype="multipart/form-data" >
...
<section class="content"  style="min-height: 10px">    
    <div class="box box-primary" style="margin-bottom: 0px">
        <div class="box-header with-border">
            ...
            <h3 class="box-title"> Reverse Split </h3>
            <div>
                <a href="{{route('reverse-splitting.index')}} " class="btn btn-primary"><i class=" fas fa-arrow-left"></i> Back</a>
            </div>
         ...
         @include('message')
            ...
            <div class = "row">
                ...
                <div class = "col-sm-3">
                  <div class="box-body">
                      <div class="form-group">
                          <label for="">Stock Break Number (e.g STB-0001)</label>
                          <input type="text" name="break_no" id="break_no" class="form-control" required>
                      </div>
                  </div>
              </div>
            </div>       
...
<script src="{{asset('assets/admin/dist/bootstrap-datepicker.js')}}"></script>
  ...
  $(document).on('keyup','.alternateIn',function(e){ var vale = $(this).val();
      ...
      $(this).parents('tr').find('.conversion_factor').val('');
  ...
  $(document).click(function(e){
    ...
    var container = $(".alternateid_data");
    // if the target of the click isn't the container nor a descendant of the container
    if (!container.is(e.target) && container.has(e.target).length === 0) 
    {
        container.hide();
    ...
    function fetchInventoryDetails(varia){
        ...
        if(type == 'item'){
            ...
            if(itemid != $this.data('id')){
                ...
                $this.parents('tr').find('.conversion_factor').val($this.data('conversion_factor'));
