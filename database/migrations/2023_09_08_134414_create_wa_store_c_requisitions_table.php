...
class CreateWaStoreCRequisitionsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_store_c_requisitions', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('wa_store_c_requisitions');
	}
}
