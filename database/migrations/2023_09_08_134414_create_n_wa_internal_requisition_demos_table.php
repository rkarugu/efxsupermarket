...
class CreateNWaInternalRequisitionDemosTable extends Migration
{
	...
	public function up()
	{
		Schema::create('n_wa_internal_requisition_demos', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('n_wa_internal_requisition_demos');
	}
}
