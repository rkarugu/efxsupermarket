...
class CreateNWaInventoryLocationTransfersTable extends Migration
{
	...
	public function up()
	{
		Schema::create('n_wa_inventory_location_transfers', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('n_wa_inventory_location_transfers');
	}
}
