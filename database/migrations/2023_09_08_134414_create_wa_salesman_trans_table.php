...
class CreateWaSalesmanTransTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_salesman_trans', function (Blueprint $table) {
			$table->increments('id');
			$table->integer('wa_sales_invoice_id')->unsigned()->nullable()->index('wa_sales_invoice_id_index');
			...
			$table->integer('wa_customer_id')->unsigned()->nullable()->index('wa_customer_id_index');
			$table->integer('wa_route_customer_id')->nullable();
			$table->string('customer_number')->nullable();
			$table->date('trans_date')->nullable();
			$table->dateTime('input_date')->nullable();
			$table->integer('wa_accounting_period_id')->unsigned()->nullable()->index('wa_accounting_period_id_index');
