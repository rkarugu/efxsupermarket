...
class CreateNWaInventoryLocationTransferItemDemosTable extends Migration
{
	...
	public function up()
	{
		Schema::create('n_wa_inventory_location_transfer_item_demos', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('n_wa_inventory_location_transfer_item_demos');
	}
}
