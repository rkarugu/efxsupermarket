...
class CreateWaCashSalesItemsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_cash_sales_items', function (Blueprint $table) {
			$table->increments('id');
			$table->string('wa_cash_sales_id')->nullable()->index('wa_cash_sales_id');
	...
	{
		Schema::drop('wa_cash_sales_items');
	}
}
