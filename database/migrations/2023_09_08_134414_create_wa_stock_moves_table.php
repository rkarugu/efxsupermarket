...
class CreateWaStockMovesTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_stock_moves', function (Blueprint $table) {
			...
			$table->integer('wa_inventory_location_transfer_new_id')->nullable();
			$table->integer('n_wa_internal_requistion_id')->nullable();
			$table->decimal('total_cost', 20)->nullable();
		});
	}
