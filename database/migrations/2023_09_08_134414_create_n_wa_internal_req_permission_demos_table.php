...
class CreateNWaInternalReqPermissionDemosTable extends Migration
{
	...
	public function up()
	{
		Schema::create('n_wa_internal_req_permission_demos', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('n_wa_internal_req_permission_demos');
	}
}
