...
class CreateWaStockCheckFreezesCTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_stock_check_freezes_c', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('wa_stock_check_freezes_c');
	}
}
