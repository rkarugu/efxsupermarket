...
class CreateWaPosCashSalesNewItemsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_pos_cash_sales_new_items', function (Blueprint $table) {
	...
	{
		Schema::drop('wa_pos_cash_sales_new_items');
	}
}
