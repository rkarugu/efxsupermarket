...
class CreateWaSalesOrderQuotationItemsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_sales_order_quotation_items', function (Blueprint $table) {
			$table->increments('id');
			$table->integer('wa_sales_order_quotation_id')->unsigned()->nullable()->index('ghghfgdfdhhkjkgdgdfhghjfghfgh');
			...
			$table->integer('unit_of_measure_id')->unsigned()->nullable()->index('ghghfgdfdhhkjkgdghfghfhghfgdfgjfghfgh');
	...
	{
		Schema::drop('wa_sales_order_quotation_items');
	}
}
