...
class CreateWaStoreCRequisitionItemsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_store_c_requisition_items', function (Blueprint $table) {
			$table->increments('id');
			$table->integer('wa_store_c_requisitions_id')->unsigned()->nullable()->index('wa_store_c_requisitions_id_parent');
	...
	{
		Schema::drop('wa_store_c_requisition_items');
	}
}
