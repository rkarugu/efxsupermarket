...
class CreateWaStockCheckFreezeItemsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('wa_stock_check_freeze_items', function (Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('wa_stock_check_freeze_items');
	}
}
