                    ...
                    <div class="col-md-3 form-group">
                        <select name="user" id="user" class="mlselect form-control">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e($user->id == request()->user ? 'selected' : ''); ?>><?php echo e($user->name); ?></option>
                    ...
                    <div class="col-md-4     form-group">
                        <select name="item" id="item" class="mlselect form-control">
                            ...
                            <?php $__currentLoopData = $pendingNewApprovalStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == request()->item ? 'selected' : ''); ?>><?php echo e($item->stock_id_code. " "); ?><?php echo e($item->title); ?></option>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": '<?php echo route('admin.maintain-items-datatable-approval'); ?>',
                    "dataType": "json",
                    "type": "POST",
                    // "data": { _token: "<?php echo e(csrf_token()); ?>", category_id: selectedCategoryId}
                    "data": function(d) {
                        // Include the selectedCategoryId in the request data
                        d._token = "<?php echo e(csrf_token()); ?>";
                        d.category_id = selectedCategoryId;
                        d.supplier_id = selectedSupplierId;
                        d.approval_status = '<?php echo e($status); ?>';
                        d.user = $('#user').val(); 
                        d.item = $('#item').val();
                    }
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kaninichapchap\resources\views/admin/maintaininvetoryitems/approval/index.blade.php ENDPATH**/ ?>