            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('item_adjustment_code', getCodeWithNumberSeries('ITEM ADJUSTMENT'), [
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('stock_id_code', $item->stock_id_code, [
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('description', $item->description, [
                                'id' => 'description',
                                'class' => 'form-control authorization_level',
                                'readonly' => true,
                            ]); ?>
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php if($item->getUnitOfMeausureDetail): ?>
                                <?php echo Form::text('uom', $item->getUnitOfMeausureDetail->title, [
                                    'id' => 'uom',
                                    'class' => 'form-control authorization_level',
                                    'readonly' => true,
                                ]); ?>
                            ...
                            <?php else: ?>
                                <?php echo Form::text('uom', null, ['id' => 'uom', 'class' => 'form-control authorization_level', 'readonly' => true]); ?>
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::number('standard_cost', $item->standard_cost, [
                                'id' => 'standard_cost',
                                'class' => 'form-control authorization_level',
                                'readonly' => true,
                            ]); ?>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::select('wa_location_and_store_id', $getLocations, null, [
                                'id' => 'location-input',
                                'class' => 'form-control authorization_level',
                                'required' => true,
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('current_qty_available', null, [
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::textArea('comments', null, [
                                'id' => 'current_qty_available',
                                'class' => 'form-control authorization_level',
                                'rows' => 4,
                            ]); ?>
                    ...
                    <div class=" row form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::number('adjustment_quantity', null, [
                                'id' => 'quantity-input',
                                'class' => 'form-control authorization_level',
                                'required' => true,
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\kaninichapchap\resources\views/admin/item_centre/modals/adjust_item_stock.blade.php ENDPATH**/ ?>