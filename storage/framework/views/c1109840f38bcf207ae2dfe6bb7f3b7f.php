...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo e(asset('assets/admin/bower_components/jquery-ui/jquery-ui.min.js')); ?>"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo e(asset('assets/admin/bower_components/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<!-- SlimScroll -->
<script src="<?php echo e(asset('assets/admin/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(asset('assets/admin/bower_components/fastclick/lib/fastclick.js')); ?>"></script>
<!-- AdminLTE App -->
...
<script src="<?php echo e(asset('assets/admin/jquery.validate.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/validation.js')); ?>"></script>
...
<?php echo $__env->yieldContent('uniquepagescriptforchart'); ?>
<?php echo $__env->yieldPushContent('scripts'); ?>

<!-- Signature validation override script -->
<script src="<?php echo e(asset('js/signature-override.js')); ?>"></script>
<?php /**PATH C:\laragon\www\kaninichapchap\resources\views/admin/includes/script.blade.php ENDPATH**/ ?>