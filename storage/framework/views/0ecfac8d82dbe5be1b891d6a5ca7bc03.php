<?php $__env->startSection('content'); ?>
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-header-flex">
                    ...
                    <div class="d-flex">
                        <?php if(can('add', 'maintain-suppliers')): ?>
                            <button data-toggle="modal" data-target="#my-suppliers-modal" data-backdrop="static"
                                class="btn btn-primary">
                                My Suppliers
                            </button>

                            <a href="<?php echo route($model . '.create'); ?>" class="btn btn-success ml-12">Add <?php echo $title; ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="box-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="goods">
                        <?php echo $__env->make('admin.maintainsuppliers.partials.goodsTable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="tab-pane" id="service">
                        <?php echo $__env->make('admin.maintainsuppliers.partials.serviceTable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="tab-pane" id="dormant">
                        <?php echo $__env->make('admin.maintainsuppliers.partials.dormantTable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php if (isset($component)) { $__componentOriginal08e3623ba7f8fedf9135994a7add3750 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal08e3623ba7f8fedf9135994a7add3750 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.suppliers.email-supplier-form','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('suppliers.email-supplier-form'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal08e3623ba7f8fedf9135994a7add3750)): ?>
<?php $attributes = $__attributesOriginal08e3623ba7f8fedf9135994a7add3750; ?>
<?php unset($__attributesOriginal08e3623ba7f8fedf9135994a7add3750); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal08e3623ba7f8fedf9135994a7add3750)): ?>
<?php $component = $__componentOriginal08e3623ba7f8fedf9135994a7add3750; ?>
<?php unset($__componentOriginal08e3623ba7f8fedf9135994a7add3750); ?>
<?php endif; ?>
    </section>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        window.user = <?php echo json_encode(getLoggeduserProfile()); ?>
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kaninichapchap\resources\views/admin/maintainsuppliers/index_server.blade.php ENDPATH**/ ?>