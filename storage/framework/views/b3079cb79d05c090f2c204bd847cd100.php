<?php $__env->startSection('content'); ?>
    <?php if(Request::url() != URL::previous()): ?>
        <a href="<?php echo URL::previous(); ?>" class="btn btn-primary">Back</a>
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route($model.'.store')); ?>" accept-charset="UTF-8" enctype="multipart/form-data"
            ...
            <div class="box box-primary">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <?php echo Form::text('emp_name', $getLoggeduserProfile->name, ['maxlength'=>'255','placeholder' => '', 'required'=>true, 'class'=>'form-control','readonly'=>true]); ?>
                        ...
                        <div class="row">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <?php echo Form::text('requisition_date', $requisition_date, ['maxlength'=>'255','placeholder' => '', 'required'=>true, 'class'=>'form-control','readonly'=>true]); ?>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" name="restaurant_id" value="<?php echo e($default_branch_id); ?>">
                        <input type="hidden" name="wa_department_id" value="<?php echo e($default_department_id); ?>">
                        <div class="row">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-5 control-label">Account</label>
                                    <div class="col-sm-6">
                                        <?php echo Form::select('customer', $customer_list , null, ['maxlength'=>'255','placeholder' => 'Customer','id'=>'customer', 'required'=>true, 'class'=>'form-control mlselec6t','onchange'=>'getcustomercredit()']); ?>
    ...
    <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <form action="<?php echo e(route('maintain-customers.add_route_customer')); ?>" method="post" class="addSubCustomer">
            <?php echo e(csrf_field()); ?>
...
">
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.vat_list', function () {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('expense.vat_find')); ?>",
                data: {
                    'id': vat
                },
        ...
        $(document).on('keyup keypress click', '.testIn', function (e) {
            ...
            if (code == 40) { //Up Arrow
                ...
                if (vale.length >= 3) {
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('pos-cash-sales.search-inventory')); ?>",
                        data: {
                            'search': vale,
                            'store_location_id': <?php echo e(getLoggeduserProfile()->wa_location_and_store_id); ?>,
        ...
        function fetchInventoryDetails(varia) {
            ...
            if (furtherCall == true) {
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('sales-invoice.getInventryItemDetails')); ?>",
                    data: {
                        'id': $this.data('id')
                    },
                    success: function (response) {
        ...
        function getcustomercredit() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('sales-invoice.getcustomercredit')); ?>",
                data: {
                    'id': customer
                },
                success: function (response) {
            ...
            $(".vat_list").select2(
                {
                    ...
                    ajax: {
                        url: '<?php echo e(route("expense.vat_list")); ?>',
                        dataType: 'json',
                        type: "GET",
                        delay: 250,
        ...
        function requestOTP() {
            $('#otpModal').modal('show');
            $.post("<?php echo e(route('credit.sales.otp-over')); ?>", {
        ...
        $(document).ready(function () {
            $('#to_store_location_id').change(function (e) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo e(route('sales-invoice.getsalesmanroute')); ?>",
                    data: {
                        'id': myval
                    },
                    success: function (response) {
...
<?php echo $__env->make('layouts.admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kaninichapchap\resources\views/admin/internalrequisition/create.blade.php ENDPATH**/ ?>